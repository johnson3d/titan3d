...
namespace McLogicAnimationEditor
{
    ...
    /// </summary>
    public partial class CreateMcLogicAnimationWindow : ResourceLibrary.WindowBase, EditorCommon.Resources.ICustomCreateDialog, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty ResourceNameProperty =
            DependencyProperty.Register("ResourceName", typeof(string), typeof(CreateMcLogicAnimationWindow), new FrameworkPropertyMetadata("", new PropertyChangedCallback(OnResourceNameChanged)));
        public static void OnResourceNameChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var win = d as CreateMcLogicAnimationWindow;
        ...
        public static readonly DependencyProperty OKButtonEnableProperty =
            DependencyProperty.Register("OKButtonEnable", typeof(bool), typeof(CreateMcLogicAnimationWindow), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(OnOKButtonEnableChanged)));
        ...
        ResourceInfos.McLAResourceCreateData mCreateData = new ResourceInfos.McLAResourceCreateData();
        ...
        public CreateMcLogicAnimationWindow()
        {
            InitializeComponent();
            SkeletonAssetNameCtrl.RNameResourceType = EngineNS.Editor.Editor_RNameTypeAttribute.Skeleton;
            SkeletonAssetNameCtrl.OnResourceNameChanged += SkeletonAssetNameCtrl_OnResourceNameChanged;
        ...
        bool mIsSkeletonSelect = false;
        bool mIsCenterDataSelect = false;
        private void SkeletonAssetNameCtrl_OnResourceNameChanged(object sender, WPG.Themes.TypeEditors.RNameControl.ResourceNameChangedEventArgs e)
        {
            if (e.Name != EngineNS.RName.EmptyName)
            {
                mIsSkeletonSelect = true;
            }
            else
            {
                mIsSkeletonSelect = false;

            }
            if (mIsSkeletonSelect && mIsCenterDataSelect)
            {
                OKButtonEnable = true;
            }
            else
            ...
            mCreateData.SkeletonAsset = e.Name.Name;
        }
        ...
        {
            mCreateData.ClassType = typeof(EngineNS.GamePlay.Component.McLogicAnimationComponent);
