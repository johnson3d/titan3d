...
namespace UIEditor.UIMacross
{
    ...
    public class UIElementPropertyCustomBindCategoryitemInitData : Macross.CategoryItem.InitializeData, INotifyPropertyChanged
    {
    ...
    public class UIElementPropertyCustomBindCategoryItemPropertys : DependencyObject, INotifyPropertyChanged, Macross.ICategoryItemPropertyClass
    {
        #region INotifyPropertyChangedMembers
        public event PropertyChangedEventHandler PropertyChanged;
        protected void OnPropertyChanged(string propertyName)
