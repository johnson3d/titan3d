...
namespace McBehaviorTreeEditor
{
    ...
    /// </summary>
    public partial class CreateMcBehaviorTreeWindow : ResourceLibrary.WindowBase, EditorCommon.Resources.ICustomCreateDialog,INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty ResourceNameProperty =
            DependencyProperty.Register("ResourceName", typeof(string), typeof(CreateMcBehaviorTreeWindow), new FrameworkPropertyMetadata("", new PropertyChangedCallback(OnResourceNameChanged)));
        public static void OnResourceNameChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var win = d as CreateMcBehaviorTreeWindow;
        ...
        public static readonly DependencyProperty OKButtonEnableProperty =
            DependencyProperty.Register("OKButtonEnable", typeof(bool), typeof(CreateMcBehaviorTreeWindow), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(OnOKButtonEnableChanged)));
        ...
        ResourceInfos.McBTResourceCreateData mCreateData = new ResourceInfos.McBTResourceCreateData();
        ...
        public CreateMcBehaviorTreeWindow()
        {
            InitializeComponent();
        ...
        {
            mCreateData.ClassType = typeof(EngineNS.GamePlay.Component.AI.McBehaviorTreeComponent);
