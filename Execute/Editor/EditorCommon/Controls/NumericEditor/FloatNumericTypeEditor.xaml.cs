...
{
    /// <summary>
    /// Interaction logic for FloatNumericTypeEditor.xaml
    /// </summary>
    public partial class FloatNumericTypeEditor : UserControl
    {
        ...
        public static readonly DependencyProperty NumericObjectProperty =
            DependencyProperty.Register("NumericObject", typeof(object), typeof(FloatNumericTypeEditor),
        ...
        public static readonly DependencyProperty BindPropertyProperty =
                            DependencyProperty.Register("BindProperty", typeof(EditorCommon.CustomPropertyDescriptor), typeof(FloatNumericTypeEditor), new FrameworkPropertyMetadata(null, new PropertyChangedCallback(OnBindPropertyChanged)));
        ...
        public static readonly DependencyProperty IsReadOnlyProperty =
            DependencyProperty.Register("IsReadOnly", typeof(bool), typeof(FloatNumericTypeEditor), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(OnIsReadOnlyChanged)));
        ...
        public bool EnableEdit
        {
            ...
            set
            {
                ...
                if (mEnableEdit)
                {
                    ...
                    Keyboard.Focus(textBox_float);
                    textBox_float.SelectionStart = 0;
                    textBox_float.SelectionLength = textBox_float.Text.Length;
                }
                else
                {
                    Keyboard.Focus(null);
		...
		private void textBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            ...
            //{
            //    System.Diagnostics.Debug.WriteLine("FloatNumericTypeEditor.textBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)\r\n" + 
            //                                       ex.ToString());
            //}
        }
