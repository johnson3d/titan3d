...
{
    public class BehaviorTree_RotateToFaceActionControlConstructionParams : BehaviorTree_BTNodeModifiersConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "RotateToFace";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as BehaviorTree_RotateToFaceActionControlConstructionParams;
            retVal.NodeName = NodeName;
            return retVal;
        }
    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(BehaviorTree_RotateToFaceActionControlConstructionParams))]
    public partial class BehaviorTree_RotateToFaceActionControl : BehaviorTree_BTNodeModifiers
    {
        ...
        public static readonly DependencyProperty PriotiryProperty = DependencyProperty.Register("Priotiry", typeof(string), typeof(BehaviorTree_RotateToFaceActionControl), new FrameworkPropertyMetadata("-1"));
        ...
        void BindingTemplateClassInstanceProperties()
        {
            ...
            //CreateBinding(mTemplateClassInstance, "CompositeNodeType", BehaviorTree_RotateToFaceActionControl.CompositeNodeTypeProperty, CompositeNodeType);

        }
        #endregion
        public BehaviorTree_RotateToFaceActionControl(BehaviorTree_RotateToFaceActionControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        {
            return "BehaviorTree_RotateToFaceActionControl";
        }

        public override Type GCode_GetType(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            return typeof(BehaviorTree_RotateToFaceActionControl);
        }
