...
{
    public class BehaviorTree_MakeNoiseActionControlConstructionParams : BehaviorTree_BTNodeModifiersConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "MakeNoise";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as BehaviorTree_MakeNoiseActionControlConstructionParams;
            retVal.NodeName = NodeName;
            return retVal;
        }
    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(BehaviorTree_MakeNoiseActionControlConstructionParams))]
    public partial class BehaviorTree_MakeNoiseActionControl : BehaviorTree_BTNodeModifiers
    {
        ...
        public static readonly DependencyProperty PriotiryProperty = DependencyProperty.Register("Priotiry", typeof(string), typeof(BehaviorTree_MakeNoiseActionControl), new FrameworkPropertyMetadata("-1"));
        ...
        void BindingTemplateClassInstanceProperties()
        {
            ...
            //CreateBinding(mTemplateClassInstance, "CompositeNodeType", BehaviorTree_MakeNoiseActionControl.CompositeNodeTypeProperty, CompositeNodeType);

        }
        #endregion
        public BehaviorTree_MakeNoiseActionControl(BehaviorTree_MakeNoiseActionControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        {
            return "BehaviorTree_MakeNoiseActionControl";
        }

        public override Type GCode_GetType(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            return typeof(BehaviorTree_MakeNoiseActionControl);
        }
