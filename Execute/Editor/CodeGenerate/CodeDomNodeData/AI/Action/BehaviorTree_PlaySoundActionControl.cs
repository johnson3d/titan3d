...
{
    public class BehaviorTree_PlaySoundActionControlConstructionParams : BehaviorTree_BTNodeModifiersConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "PlaySound";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as BehaviorTree_PlaySoundActionControlConstructionParams;
            retVal.NodeName = NodeName;
            return retVal;
        }
    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(BehaviorTree_PlaySoundActionControlConstructionParams))]
    public partial class BehaviorTree_PlaySoundActionControl : BehaviorTree_BTNodeModifiers
    {
        ...
        public static readonly DependencyProperty PriotiryProperty = DependencyProperty.Register("Priotiry", typeof(string), typeof(BehaviorTree_PlaySoundActionControl), new FrameworkPropertyMetadata("-1"));
        ...
        void BindingTemplateClassInstanceProperties()
        {
            ...
            //CreateBinding(mTemplateClassInstance, "CompositeNodeType", BehaviorTree_PlaySoundActionControl.CompositeNodeTypeProperty, CompositeNodeType);

        }
        #endregion
        public BehaviorTree_PlaySoundActionControl(BehaviorTree_PlaySoundActionControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        {
            return "BehaviorTree_PlaySoundActionControl";
        }

        public override Type GCode_GetType(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            return typeof(BehaviorTree_PlaySoundActionControl);
        }
