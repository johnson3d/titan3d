...
namespace CodeDomNode
{
    ...
    public class ListRemoveConstructParam : CodeGenerateSystem.Base.ConstructionParams
    {

    }
    [CodeGenerateSystem.CustomConstructionParams(typeof(ListRemoveConstructParam))]
    public partial class ListRemove : CodeGenerateSystem.Base.BaseNodeControl
    {
        ...
        CodeGenerateSystem.Base.LinkPinControl mResultOutPin = new CodeGenerateSystem.Base.LinkPinControl();
        ...
        public ListRemove(CodeGenerateSystem.Base.ConstructionParams csParam)
            : base(csParam)
        {
            ...
            AddLinkPinInfo("ResultOutPin", mResultOutPin);
        }
        ...
        public static void InitNodePinTypes(CodeGenerateSystem.Base.ConstructionParams csParam)
        {
            ...
            CollectLinkPinInfo(csParam, "ResultOutPin", typeof(bool), CodeGenerateSystem.Base.enBezierType.Right, CodeGenerateSystem.Base.enLinkOpType.Start, true);
        }
        ...
        {
            if (element == mResultOutPin || element == null)
                return $"linkAddIndex_" + EngineNS.Editor.Assist.GetValuedGUIDString(Id);
            else
                throw new InvalidOperationException();
        }
        ...
        {
            if (element == null || element == mResultOutPin)
        ...
        public override async System.Threading.Tasks.Task GCode_CodeDom_GenerateCode(CodeTypeDeclaration codeClass, CodeStatementCollection codeStatementCollection, CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            ...
            if (mArrayInPin.HasLink)
            {
                ...
                CodeGenerateSystem.CodeDom.CodeMethodInvokeExpression methodInvokeExp = null;
                if (mValueInPin.HasLink)
                {
                    ...
                    methodInvokeExp = new CodeGenerateSystem.CodeDom.CodeMethodInvokeExpression(
                                                                tagExp,
                                                                "Remove",
                ...
                if (mResultOutPin.HasLink)
                {
                    // 参考代码 var idx = xxx.Remove(aaa);
                    codeStatementCollection.Add(new CodeAssignStatement(GCode_CodeDom_GetValue(null, context), methodInvokeExp));
                }
                else
                {
