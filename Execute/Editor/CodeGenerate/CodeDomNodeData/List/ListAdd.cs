...
namespace CodeDomNode
{
    ...
    public class ListAddConstructParam : CodeGenerateSystem.Base.ConstructionParams
    {

    }
    [CodeGenerateSystem.CustomConstructionParams(typeof(ListAddConstructParam))]
    public partial class ListAdd : CodeGenerateSystem.Base.BaseNodeControl
    {
        ...
        public ListAdd(CodeGenerateSystem.Base.ConstructionParams csParam)
            : base(csParam)
        {
        ...
        public override string GCode_GetValueName(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            if (element == mIndexOutPin || element == null)
                return $"listAddIndex_" + EngineNS.Editor.Assist.GetValuedGUIDString(Id);
            else
                throw new InvalidOperationException();
        }
        ...
        public override async System.Threading.Tasks.Task GCode_CodeDom_GenerateCode(CodeTypeDeclaration codeClass, CodeStatementCollection codeStatementCollection, CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            ...
            if(mArrayInPin.HasLink)
            {
                ...
                if (mIndexOutPin.HasLink)
                {
                    ...
                    codeStatementCollection.Add(new CodeAssignStatement(GCode_CodeDom_GetValue(null, context),
                                                                        new CodeBinaryOperatorExpression(
                                                                            new CodePropertyReferenceExpression(tagExp, "Count"),
