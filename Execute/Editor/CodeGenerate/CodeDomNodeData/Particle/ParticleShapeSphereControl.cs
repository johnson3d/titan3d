...
namespace CodeDomNode.Particle
{
    ...
    public class ParticleShapeSphereControlConstructionParams : StructNodeControlConstructionParams
    {

        [EngineNS.Rtti.MetaData]
        public Type CreateType { get; set; } = typeof(EngineNS.Bricks.Particle.EmitShape.CGfxParticleEmitterShapeSphere);//测试Box

        [EngineNS.Rtti.MetaData]
        public override string BaseClassName { get; set; } = "EngineNS.Bricks.Particle.ParticleEmitShapeNode";
        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as ParticleShapeSphereControlConstructionParams;
            retVal.CreateType = CreateType;
            return retVal;
        }

    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(ParticleShapeSphereControlConstructionParams))]
    public partial class ParticleShapeSphereControl : CodeGenerateSystem.Base.BaseNodeControl, IParticleNode, IParticleShape, IParticleSaveData
    {
        ...
        public ParticleShapeSphereControl(ParticleShapeSphereControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        {
            return "ShapeSphere_" + Id.ToString().Replace("-", "_");
        }
        ...
        {
            var param = CSParam as ParticleShapeSphereControlConstructionParams;
            var assist = this.HostNodesContainer.HostControl;
            var TitleString = HostNodesContainer.TitleString;
        ...
        private void CreateParticleMethodCategory(string methodname, float x, float y)
        {
            ...
            var csparam = CSParam as ParticleShapeSphereControlConstructionParams;
        ...
        {
            ParticleDataSaveLoad.SaveData("ParticleShapeNode", xndNode, newGuid, CSParam as ParticleShapeSphereControlConstructionParams, this, mLinkedNodesContainer);
        ...
        {
            //await AwaitLoad();
            NeedResetLoadValue = await ParticleDataSaveLoad.LoadData2("ParticleShapeNode", xndNode, CSParam as ParticleShapeSphereControlConstructionParams, this, mLinkedNodesContainer);
        ...
        {
            return typeof(ParticleShapeSphereControl);
        }
