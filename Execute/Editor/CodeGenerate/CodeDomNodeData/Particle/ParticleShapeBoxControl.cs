...
namespace CodeDomNode.Particle
{
    ...
    public class ParticleShapeBoxControlConstructionParams : StructNodeControlConstructionParams
    {

        [EngineNS.Rtti.MetaData]
        public Type CreateType { get; set; } = typeof(EngineNS.Bricks.Particle.EmitShape.CGfxParticleEmitterShapeBox);//测试Box

        [EngineNS.Rtti.MetaData]
        public override string BaseClassName { get; set; } = "EngineNS.Bricks.Particle.ParticleEmitShapeNode";
        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as ParticleShapeBoxControlConstructionParams;
            retVal.CreateType = CreateType;
            return retVal;
        }

    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(ParticleShapeBoxControlConstructionParams))]
    public partial class ParticleShapeBoxControl : CodeGenerateSystem.Base.BaseNodeControl, IParticleNode, IParticleShape, IParticleSaveData
    {
        ...
        public ParticleShapeBoxControl(ParticleShapeBoxControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        {
            return "ShapeBox_" + Id.ToString().Replace("-", "_");
        }
        ...
        {
            var param = CSParam as ParticleShapeBoxControlConstructionParams;
            var assist = this.HostNodesContainer.HostControl;
            var TitleString = HostNodesContainer.TitleString;
        ...
        {
            ParticleDataSaveLoad.SaveData("ParticleShapeNode", xndNode, newGuid, CSParam as ParticleShapeBoxControlConstructionParams, this, mLinkedNodesContainer);
        ...
        {
            //await AwaitLoad();
            NeedResetLoadValue = await ParticleDataSaveLoad.LoadData2("ParticleShapeNode", xndNode, CSParam as ParticleShapeBoxControlConstructionParams, this, mLinkedNodesContainer);
        ...
        {
            return typeof(ParticleShapeBoxControl);
        }
