...
{
    public class ParticleAcceleratedControlConstructionParams : StructNodeControlConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public override string BaseClassName { get; set; } = "EngineNS.Bricks.Particle.AcceleratedNode";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as ParticleAcceleratedControlConstructionParams;
            return retVal;
        }

    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(ParticleAcceleratedControlConstructionParams))]
    public partial class ParticleAcceleratedControl : CodeGenerateSystem.Base.BaseNodeControl, IParticleNode, IParticleSaveData, IParticleGradient
    {
        ...
        {
            return "AcceleratedNode_" + Id.ToString().Replace("-", "_");
        }
        ...
        {
            var param = CSParam as ParticleAcceleratedControlConstructionParams;
        ...
        private void CreateParticleMethodCategory(string methodname, float x, float y)
        {
            ...
            Type type = typeof(EngineNS.Bricks.Particle.AcceleratedNode);
        ...
        protected override void EndLink(LinkPinControl linkObj)
        {
            ...
            var pinInfo = GetLinkPinInfo("ParticleAcceleratedControlDown");
        ...
        {
            CollectLinkPinInfo(smParam, "ParticleAcceleratedControlDown", CodeGenerateSystem.Base.enLinkType.Module, CodeGenerateSystem.Base.enBezierType.Left, CodeGenerateSystem.Base.enLinkOpType.Start, false);
            CollectLinkPinInfo(smParam, "ParticleAcceleratedControlUp", CodeGenerateSystem.Base.enLinkType.Module, CodeGenerateSystem.Base.enBezierType.Right, CodeGenerateSystem.Base.enLinkOpType.End, true);
        }
        ...
        {
            return typeof(ParticleAcceleratedControl);
        }
