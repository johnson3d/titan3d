...
namespace CodeDomNode.Particle
{
    public partial class StructLinkControl : LinkPinControl
    {
        ...
        List<string> mFilter = new List<string>();
        public void AddFilterData(string data)
        {
            mFilter.Add(data);
        }

        public void ResetDefaultFilter(string removename = null)
        {
            AddFilterData("ParticleColorControlUp");
            AddFilterData("ParticleScaleControlUp");
            AddFilterData("ParticleComposeControlRight");
            AddFilterData("ParticleComposeControlLeft");
            AddFilterData("ParticleVelocityControlUp");
            AddFilterData("ParticleVelocityByCenterControlUp");
            AddFilterData("ParticleVelocityByTangentControlUp");
            AddFilterData("ParticleRotationControlUp");
            AddFilterData("ParticleAcceleratedControlUp");
            
            RemoveFilterData(removename);
        }

        public void ResetDefaultFilterBySystem(string removename = null)
        {
            AddFilterData("ParticleTrailControlUp");
            AddFilterData("ParticleTextureCutControlUp");
            AddFilterData("ParticleMaterialInstanceControlUp");
            AddFilterData("ParticleTriggerControlUp");
            AddFilterData("ParticlePointGravityControlUp");
            
            RemoveFilterData(removename);
        }

        public void ResetDefaultFilterByShape(string removename = null)
        {
            AddFilterData("ParticleStateControlUp");
            AddFilterData("ParticleRandomDirectionControlUp");
            AddFilterData("ParticleTransformControlUp");
            
            RemoveFilterData(removename);
        }

        public void RemoveFilterData(string name)
        {
        ...
        public bool CanLinkWithByFilter(string name)
        {
            if (mFilter.Count == 0)
                return false;
        ...
        public override bool CanLinkWith(BaseNodeControl.LinkPinDescDic.PinDesc desc)
        {
            ...
            if ((LinkType & desc.PinType) > 0)
            {
                if (string.IsNullOrEmpty(ClassType) || string.IsNullOrEmpty(desc.ClassType))
                    return CanLinkWithByFilter(desc.Name);
        ...
        //    //    {
        //    //        var linkInfo = new ModuleLinkInfo(MainDrawCanvas, startObj, endObj);
