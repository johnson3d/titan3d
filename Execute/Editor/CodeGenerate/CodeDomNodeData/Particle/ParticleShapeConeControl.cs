...
namespace CodeDomNode.Particle
{
    ...
    public class ParticleShapeConeControlConstructionParams : StructNodeControlConstructionParams
    {

        [EngineNS.Rtti.MetaData]
        public Type CreateType { get; set; } = typeof(EngineNS.Bricks.Particle.EmitShape.CGfxParticleEmitterShapeCone);//测试Box

        [EngineNS.Rtti.MetaData]
        public override string BaseClassName { get; set; } = "EngineNS.Bricks.Particle.ParticleEmitShapeNode";
        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as ParticleShapeConeControlConstructionParams;
            retVal.CreateType = CreateType;
            return retVal;
        }

    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(ParticleShapeConeControlConstructionParams))]
    public partial class ParticleShapeConeControl : CodeGenerateSystem.Base.BaseNodeControl, IParticleNode, IParticleShape, IParticleSaveData
    {
        ...
        public ParticleShapeConeControl(ParticleShapeConeControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        {
            return "ShapeCone_" + Id.ToString().Replace("-", "_");
        }
        ...
        {
            ParticleDataSaveLoad.SaveData("ParticleShapeNode", xndNode, newGuid, CSParam as ParticleShapeConeControlConstructionParams, this, mLinkedNodesContainer);
        ...
        {
            //await AwaitLoad();
            NeedResetLoadValue = await ParticleDataSaveLoad.LoadData2("ParticleShapeNode", xndNode, CSParam as ParticleShapeConeControlConstructionParams, this, mLinkedNodesContainer);
        ...
        {
            return typeof(ParticleShapeConeControl);
        }
