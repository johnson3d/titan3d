...
{
    public class ParticleRotationControlConstructionParams : StructNodeControlConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public override string BaseClassName { get; set; } = "EngineNS.Bricks.Particle.RotationNode";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as ParticleRotationControlConstructionParams;
            return retVal;
        }

    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(ParticleRotationControlConstructionParams))]
    public partial class ParticleRotationControl : CodeGenerateSystem.Base.BaseNodeControl, IParticleNode, IParticleGradient
    {
            ...
            if (sys.SubParticleSystems != null && sys.SubParticleSystems.Count != 0)
            {
                for (int i = 0; i < sys.SubParticleSystems.Count; i++)
                {
                    ...
                    if (subsys.SubStates != null)
                    {
                        ...
                        {
                            var nodes = subsys.SubStates[j].RotationNodes;
                            if (nodes != null)
                            {
                        ...
                        for (int j = 0; j < subsys.SubStates.Length; j++)
                        {
                            ...
                            if (nodes != null)
                            {
                                ...
                                { 
                                    ...
                                    {
                                        nodes[n] = DataGradient.PDataGradient as EngineNS.Bricks.Particle.RotationNode;
                                        return;
                                    }
                                }
                            }
        ...
        {
            return "RotationNode" + Id.ToString().Replace("-", "_");
        }
        ...
        {
            //var test = InitGraph();
            //test = ParticleDataSaveLoad.LoadData(CSParam as StructNodeControlConstructionParams, mLinkedNodesContainer, this);
        }
        ...
        {
            var param = CSParam as ParticleRotationControlConstructionParams;
        ...
        private void CreateParticleMethodCategory(string methodname, float x, float y)
        {
            ...
            Type type = typeof(EngineNS.Bricks.Particle.RotationNode);
        ...
        protected override void EndLink(LinkPinControl linkObj)
        {
            ...
            var pinInfo = GetLinkPinInfo("ParticleRotationControlDown");
        ...
        public override async System.Threading.Tasks.Task Load(XndNode xndNode)
        {
            ...
            //}
            //await AwaitLoad();
            //await ParticleDataSaveLoad.LoadData("ParticleRotationNode", xndNode, CSParam as ParticleRotationControlConstructionParams, this, mLinkedNodesContainer);
        ...
        {
            CollectLinkPinInfo(smParam, "ParticleRotationControlDown", CodeGenerateSystem.Base.enLinkType.Module, CodeGenerateSystem.Base.enBezierType.Left, CodeGenerateSystem.Base.enLinkOpType.Start, false);
            CollectLinkPinInfo(smParam, "ParticleRotationControlUp", CodeGenerateSystem.Base.enLinkType.Module, CodeGenerateSystem.Base.enBezierType.Right, CodeGenerateSystem.Base.enLinkOpType.End, true);
        }
        ...
        {
            return typeof(ParticleRotationControl); 
        }
        ...
        public override async System.Threading.Tasks.Task GCode_CodeDom_GenerateCode(CodeTypeDeclaration codeClass, CodeStatementCollection codeStatementCollection, LinkPinControl element, GenerateCodeContext_Method context)
        {
            ...
            DataGradient.GCode_CodeDom_GenerateCode(codeClass, GetClassName(), "StartValue2", true);
