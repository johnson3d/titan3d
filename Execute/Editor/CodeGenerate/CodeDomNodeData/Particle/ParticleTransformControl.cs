...
{
    public class ParticleTransformControlConstructionParams : StructNodeControlConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public override string BaseClassName { get; set; } = "EngineNS.Bricks.Particle.TransformNode";
        
        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as ParticleTransformControlConstructionParams;
            return retVal;
        }

    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(ParticleTransformControlConstructionParams))]
    public partial class ParticleTransformControl : CodeGenerateSystem.Base.BaseNodeControl, IParticleNode, IParticleGradient
    {
        ...
        public ParticleDataGradientTF DataGradient;
        public ParticleTransformControl(ParticleTransformControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
            ...
            {
                NodeName = "ParticleTransform";
            }

            IsOnlyReturnValue = true;
            AddLinkPinInfo("ParticleTransformControlDown", mCtrlValueLinkHandleDown, null);
            AddLinkPinInfo("ParticleTransformControlUp", mCtrlValueLinkHandleUp, null);

            mCtrlValueLinkHandleDown.ResetDefaultFilter();
            mCtrlValueLinkHandleDown.ResetDefaultFilterByShape("ParticleTransformControlUp");

            DataGradient = new ParticleDataGradientTF();
        }
        ...
        {
            if (DataGradient.TransformNode == null)
            {
                return;
            }
            ...
            if (sys.SubParticleSystems != null && sys.SubParticleSystems.Count != 0)
            {
                for (int i = 0; i < sys.SubParticleSystems.Count; i++)
                {
                    ...
                    if (subsys.SubStates != null)
                    {
                        ...
                        {
                            if (subsys.SubStates[j].TransformNode != null)
                            {
                                if (subsys.SubStates[j].TransformNode.GetType().Name.Equals(GetClassName()))
                                {
                                    subsys.SubStates[j].TransformNode = DataGradient.TransformNode;
                                    return;
                                }
                            }
        ...
        {
            DataGradient.TransformNode = null;
                    ...
                    if (subsys.SubStates != null)
                    {
                        for (int j = 0; j < subsys.SubStates.Length; j++)
                        {
                            if (subsys.SubStates[j].TransformNode != null)
                            {
                                if (subsys.SubStates[j].TransformNode.GetType().Name.Equals(GetClassName()))
                                {
                                    DataGradient.TransformNode = subsys.SubStates[j].TransformNode;
                                    break;
                                }
                            }
        ...
        {
            return "TransformNode_" + Id.ToString().Replace("-", "_");
        }
        ...
        {
            var param = CSParam as ParticleTransformControlConstructionParams;
        ...
        private void CreateParticleMethodCategory(string methodname, float x, float y)
        {
            ...
            Type type = typeof(EngineNS.Bricks.Particle.TransformNode);
        ...
        protected override void EndLink(LinkPinControl linkObj)
        {
            ...
            var pinInfo = GetLinkPinInfo("ParticleTransformControlDown");
        ...
        {
            //ParticleDataSaveLoad.SaveData("ParticleTransformNode", xndNode, newGuid, CSParam as ParticleTransformControlConstructionParams, this);

            var csParam = CSParam as ParticleTransformControlConstructionParams;
        ...
        public override async System.Threading.Tasks.Task Load(XndNode xndNode)
        {
            ...
            //}
            //await AwaitLoad();
            //await ParticleDataSaveLoad.LoadData("ParticleTransformNode", xndNode, CSParam as ParticleTransformControlConstructionParams, this, mLinkedNodesContainer);
        ...
        {
            CollectLinkPinInfo(smParam, "ParticleTransformControlDown", CodeGenerateSystem.Base.enLinkType.Module, CodeGenerateSystem.Base.enBezierType.Left, CodeGenerateSystem.Base.enLinkOpType.Start, false);
            CollectLinkPinInfo(smParam, "ParticleTransformControlUp", CodeGenerateSystem.Base.enLinkType.Module, CodeGenerateSystem.Base.enBezierType.Right, CodeGenerateSystem.Base.enLinkOpType.End, true);
        }
        ...
        {
            return typeof(ParticleTransformControl);
        }
