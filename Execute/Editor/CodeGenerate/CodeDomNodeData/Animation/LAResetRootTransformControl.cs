...
{
    public class LAResetRootTransformControlConstructionParams : SkeletonConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public float Alpha { get; set; } = 1.0f;
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "ResetRootTransform";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as LAResetRootTransformControlConstructionParams;
    ...
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(LAResetRootTransformControlConstructionParams))]
    public partial class LAResetRootTransformControl : CodeGenerateSystem.Base.BaseNodeControl
    {
        ...
        public float Alpha
        {
            ...
            set
            {
                ...
                var para = CSParam as LAResetRootTransformControlConstructionParams;
                para.Alpha = value;
            }
        }
        public static readonly DependencyProperty AlphaProperty = DependencyProperty.Register("Alpha", typeof(float), typeof(LAResetRootTransformControl), new UIPropertyMetadata(1.0f, OnAlphaPropertyyChanged));
        private static void OnAlphaPropertyyChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            var ctrl = sender as LAResetRootTransformControl;
        ...
        void BindingTemplateClassInstanceProperties()
        {
            ...
            CreateBinding(mTemplateClassInstance, "Alpha", LAResetRootTransformControl.AlphaProperty, Alpha);
        ...
        public LAResetRootTransformControl(LAResetRootTransformControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        void InitializeLinkControl(LAResetRootTransformControlConstructionParams csParam)
        {
        ...
        {
            return "LAResetRootTransformControl";
        }

        public override Type GCode_GetType(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            return typeof(LAResetRootTransformControl);
        }
