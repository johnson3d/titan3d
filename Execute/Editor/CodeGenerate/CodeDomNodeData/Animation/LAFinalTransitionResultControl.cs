...
{
    public class LAFinalTransitionResultConstructionParams : CodeGenerateSystem.Base.AnimMacrossConstructionParams
    {

    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(LAFinalTransitionResultConstructionParams))]
    public partial class LAFinalTransitionResultControl : CodeGenerateSystem.Base.BaseNodeControl
    {
        CodeGenerateSystem.Base.LinkPinControl mCtrlValueInputHandle = new CodeGenerateSystem.Base.LinkPinControl();
        partial void InitConstruction();
        public LAFinalTransitionResultControl(LAFinalTransitionResultConstructionParams csParam) : base(csParam)
        {
            InitConstruction();
