...
{
    public class LAFABRIKControlConstructionParams : SkeletonConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public float Alpha { get; set; } = 1.0f;
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "FABRIK";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as LAFABRIKControlConstructionParams;
    ...
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(LAFABRIKControlConstructionParams))]
    public partial class LAFABRIKControl : CodeGenerateSystem.Base.BaseNodeControl
    {
        ...
        public float Alpha
        {
            ...
            set
            {
                ...
                var para = CSParam as LAFABRIKControlConstructionParams;
                para.Alpha = value;
            }
        }
        public static readonly DependencyProperty AlphaProperty = DependencyProperty.Register("Alpha", typeof(float), typeof(LAFABRIKControl), new UIPropertyMetadata(1.0f, OnAlphaPropertyyChanged));
        private static void OnAlphaPropertyyChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            var ctrl = sender as LAFABRIKControl;
        ...
        void BindingTemplateClassInstanceProperties()
        {
            ...
            CreateBinding(mTemplateClassInstance, "Alpha", LAFABRIKControl.AlphaProperty, Alpha);
        ...
        {
            return "LAFABRIKControl";
        }

        public override Type GCode_GetType(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            return typeof(LAFABRIKControl);
        }
