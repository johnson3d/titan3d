...
{
    public class LAMaskPoseControlConstructionParams : CodeGenerateSystem.Base.ConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public float Alpha { get; set; } = 1.0f;
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "MaskPose";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as LAMaskPoseControlConstructionParams;
    ...
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(LAMaskPoseControlConstructionParams))]
    public partial class LAMaskPoseControl : CodeGenerateSystem.Base.BaseNodeControl
    {
        ...
        public float Alpha
        {
            ...
            set
            {
                ...
                var para = CSParam as LAMaskPoseControlConstructionParams;
                para.Alpha = value;
            }
        }
        public static readonly DependencyProperty AlphaProperty = DependencyProperty.Register("Alpha", typeof(float), typeof(LAMaskPoseControl), new UIPropertyMetadata(1.0f, OnAlphaPropertyyChanged));
        private static void OnAlphaPropertyyChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            var ctrl = sender as LAMaskPoseControl;
        ...
        void BindingTemplateClassInstanceProperties()
        {
            ...
            CreateBinding(mTemplateClassInstance, "Alpha", LAMaskPoseControl.AlphaProperty, Alpha);
        ...
        public LAMaskPoseControl(LAMaskPoseControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        CodeGenerateSystem.Base.LinkPinControl mBasePoseLinkHandle = new CodeGenerateSystem.Base.LinkPinControl();
        CodeGenerateSystem.Base.LinkPinControl mMaskLinkHandle = new CodeGenerateSystem.Base.LinkPinControl();
        ...
        void InitializeLinkControl(LAMaskPoseControlConstructionParams csParam)
        {
            mBasePoseLinkHandle = BasePoseHandle;
            mMaskLinkHandle = MaskHandle;
            mAlphaValueLinkHandle = AlphaValueHandle;
            mOutLinkHandle = OutPoseHandle;
            mBasePoseLinkHandle.MultiLink = false;
            mMaskLinkHandle.MultiLink = false;
            mAlphaValueLinkHandle.MultiLink = false;
            mOutLinkHandle.MultiLink = false;

            mBasePoseLinkHandle.NameStringVisible = Visibility.Visible;
            mBasePoseLinkHandle.NameString = "BasePose";
            mMaskLinkHandle.NameStringVisible = Visibility.Visible;
            mMaskLinkHandle.NameString = "Mask";
            ...
            AlphaValueTextBlock.Visibility = Visibility.Visible;
            mAlphaValueLinkHandle.OnAddLinkInfo += WeightValueLinkHandle_OnAddLinkInfo;
            mAlphaValueLinkHandle.OnDelLinkInfo += WeightValueLinkHandle_OnDelLinkInfo;
            AddLinkPinInfo("BasePoseLinkHandle", mBasePoseLinkHandle, null);
            AddLinkPinInfo("MaskLinkHandle", mMaskLinkHandle, null);
        ...
        {
            CollectLinkPinInfo(smParam, "BasePoseLinkHandle", CodeGenerateSystem.Base.enLinkType.AnimationPose, CodeGenerateSystem.Base.enBezierType.Left, CodeGenerateSystem.Base.enLinkOpType.End, false);
            CollectLinkPinInfo(smParam, "MaskLinkHandle", CodeGenerateSystem.Base.enLinkType.AnimationPose, CodeGenerateSystem.Base.enBezierType.Left, CodeGenerateSystem.Base.enLinkOpType.End, false);
        ...
        {
            return "LAMaskPoseControl";
        }

        public override Type GCode_GetType(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            return typeof(LAMaskPoseControl);
        }
