...
{
    public class LATwoBoneIKControlConstructionParams : SkeletonConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public float Alpha { get; set; } = 1.0f;
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "TwoBoneIK";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as LATwoBoneIKControlConstructionParams;
    ...
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(LATwoBoneIKControlConstructionParams))]
    public partial class LATwoBoneIKControl : CodeGenerateSystem.Base.BaseNodeControl
    {
        ...
        public float Alpha
        {
            ...
            set
            {
                ...
                var para = CSParam as LATwoBoneIKControlConstructionParams;
                para.Alpha = value;
            }
        }
        public static readonly DependencyProperty AlphaProperty = DependencyProperty.Register("Alpha", typeof(float), typeof(LATwoBoneIKControl), new UIPropertyMetadata(1.0f, OnAlphaPropertyyChanged));
        private static void OnAlphaPropertyyChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            var ctrl = sender as LATwoBoneIKControl;
        ...
        void BindingTemplateClassInstanceProperties()
        {
            ...
            CreateBinding(mTemplateClassInstance, "Alpha", LATwoBoneIKControl.AlphaProperty, Alpha);
        ...
        public LATwoBoneIKControl(LATwoBoneIKControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        void InitializeLinkControl(LATwoBoneIKControlConstructionParams csParam)
        {
        ...
        {
            return "LATwoBoneIKControl";
        }

        public override Type GCode_GetType(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            return typeof(LATwoBoneIKControl);
        }
