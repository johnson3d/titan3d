...
{
    public class LAZeroPoseControlConstructionParams : CodeGenerateSystem.Base.ConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "ZeroPose";
        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as LAZeroPoseControlConstructionParams;
            retVal.NodeName = NodeName;
            return retVal;
        }
    }
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(LAZeroPoseControlConstructionParams))]
    public partial class LAZeroPoseControl : CodeGenerateSystem.Base.BaseNodeControl
    {
        ...
        public static readonly DependencyProperty TitleImageProperty = DependencyProperty.Register("TitleImage", typeof(ImageSource), typeof(LAZeroPoseControl), new FrameworkPropertyMetadata(null));
        ...
        #endregion
        public LAZeroPoseControl(LAZeroPoseControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        void InitializeLinkControl(LAZeroPoseControlConstructionParams csParam)
        {
        ...
        {
            return "LAZeroPoseControl";
        }

        public override Type GCode_GetType(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            return typeof(LAZeroPoseControl);
        }
