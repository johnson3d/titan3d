...
{
    public class LABoneDrivenControllerControlConstructionParams : SkeletonConstructionParams
    {
        [EngineNS.Rtti.MetaData]
        public float Alpha { get; set; } = 1.0f;
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "LABoneDrivenController";

        public override EditorCommon.CodeGenerateSystem.INodeConstructionParams Duplicate()
        {
            var retVal = base.Duplicate() as LABoneDrivenControllerControlConstructionParams;
    ...
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(LABoneDrivenControllerControlConstructionParams))]
    public partial class LABoneDrivenControllerControl : CodeGenerateSystem.Base.BaseNodeControl
    {
        ...
        public float Alpha
        {
            ...
            set
            {
                ...
                var para = CSParam as LABoneDrivenControllerControlConstructionParams;
                para.Alpha = value;
            }
        }
        public static readonly DependencyProperty AlphaProperty = DependencyProperty.Register("Alpha", typeof(float), typeof(LABoneDrivenControllerControl), new UIPropertyMetadata(1.0f, OnAlphaPropertyyChanged));
        private static void OnAlphaPropertyyChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            var ctrl = sender as LABoneDrivenControllerControl;
        ...
        void BindingTemplateClassInstanceProperties()
        {
            ...
            CreateBinding(mTemplateClassInstance, "Alpha", LABoneDrivenControllerControl.AlphaProperty, Alpha);
        ...
        public LABoneDrivenControllerControl(LABoneDrivenControllerControlConstructionParams csParam)
            : base(csParam)
        {
            InitConstruction();
        ...
        void InitializeLinkControl(LABoneDrivenControllerControlConstructionParams csParam)
        {
        ...
        {
            return "LABoneDrivenControllerControl";
        }

        public override Type GCode_GetType(CodeGenerateSystem.Base.LinkPinControl element, CodeGenerateSystem.Base.GenerateCodeContext_Method context)
        {
            return typeof(LABoneDrivenControllerControl);
        }
