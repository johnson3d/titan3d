...
{
    public class LABlendSpaceControlConstructionParams : ConstructionParams
    {
        ...
        [EngineNS.Rtti.MetaData]
        public string NodeName { get; set; } = "BlendSpace";
        [EngineNS.Rtti.MetaData]
        ...
        {
            var retVal = base.Duplicate() as LABlendSpaceControlConstructionParams;
    ...
    [CodeGenerateSystem.CustomConstructionParamsAttribute(typeof(LABlendSpaceControlConstructionParams))]
    public partial class LABlendSpaceControl : BaseNodeControl
    {
        public Action<EngineNS.RName> OnAdded = null;
        ...
        public static readonly DependencyProperty TitleImageProperty = DependencyProperty.Register("TitleImage", typeof(ImageSource), typeof(LABlendSpaceControl), new FrameworkPropertyMetadata(null));
        ...
        public string SyncPlayPercentGrop
        {
            ...
            set
            {
                ...
                var para = CSParam as LABlendSpaceControlConstructionParams;
                para.SyncPlayPercentGrop = value;
            }
        }
        public static readonly DependencyProperty SyncPlayPercentGropProperty = DependencyProperty.Register("ActiveValue", typeof(string), typeof(LABlendSpaceControl), new UIPropertyMetadata("", OnSyncPlayPercentGropPropertyyChanged));
        private static void OnSyncPlayPercentGropPropertyyChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            var ctrl = sender as LABlendSpaceControl;
        ...
        private void LABlendSpaceControl_OnXAxisNameChange(string newName)
        {
            XValueHandle.NameString = newName;
        }
        private void LABlendSpaceControl_OnYAxisNameChange(string newName)
        {
