...
{
    [CodeGenerateSystem.ShowInNodeList("测试/旋转(Particle 旋转结点)", "Particle 旋转结点")]
    public partial class ParticleRotationControl
    {
        ...
        {
            var node = base.Duplicate(param) as ParticleRotationControl;
