...
{
    [CodeGenerateSystem.ShowInNodeList("测试/测试(Particle Shape Mesh)", "测试Particle Shape Mesh")]
    public partial class ParticleShapeMeshControl
    {
        public ParticleShapeMeshControl()
        {
            InitConstruction();
        }
        ...
        {
            var node = base.Duplicate(param) as ParticleShapeMeshControl;
