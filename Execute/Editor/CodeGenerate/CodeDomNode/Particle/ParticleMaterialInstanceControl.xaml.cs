...
{
    [CodeGenerateSystem.ShowInNodeList("测试/材质实例(Particle 材质实例)", "材质实例")]
    public partial class ParticleMaterialInstanceControl
    {
        public ParticleMaterialInstanceControl()
        {
            InitConstruction();
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            grid.Background = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromArgb(255, 95, 61, 61));//103,78,148
        }
    }
}
