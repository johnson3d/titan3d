...
{
    [CodeGenerateSystem.ShowInNodeList("测试/测试(Particle Shape Box)", "测试Particle Shape Box")]
    public partial class ParticleShapeBoxControl
    {
        ...
        {
            var node = base.Duplicate(param) as ParticleShapeBoxControl;
