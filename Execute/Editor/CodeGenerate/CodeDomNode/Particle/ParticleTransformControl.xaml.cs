...
{
    [CodeGenerateSystem.ShowInNodeList("测试/测试(Particle Transform)", "矩阵Particle Scale")]
    public partial class ParticleTransformControl
    {
        public ParticleTransformControl()
        {
            InitConstruction();
        }
