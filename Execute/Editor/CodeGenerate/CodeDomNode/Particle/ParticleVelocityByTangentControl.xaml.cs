...
{
    [CodeGenerateSystem.ShowInNodeList("测试/测试(Particle 切线运动结点)", "Particle 切线运动结点")]
    public partial class ParticleVelocityByTangentControl
    {
        public ParticleVelocityByTangentControl()
        {
            InitConstruction();
        }
