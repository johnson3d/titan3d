...
{
    [CodeGenerateSystem.ShowInNodeList("测试/测试(Particle TextureCut)", "测试Particle TextureCut")]
    public partial class ParticleTextureCutControl
    {
        public ParticleTextureCutControl()
        {
            InitConstruction();
        }
