...
{
    [CodeGenerateSystem.ShowInNodeList("测试/测试(Particle PointGravity)", "测试Particle PointGravity")]
    public partial class ParticlePointGravityControl
    {
        public ParticlePointGravityControl()
        {
            InitConstruction();
        }
        ...
        {
            var node = base.Duplicate(param) as ParticlePointGravityControl;
