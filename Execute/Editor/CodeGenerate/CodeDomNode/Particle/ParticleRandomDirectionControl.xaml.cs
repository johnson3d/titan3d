...
{
    [CodeGenerateSystem.ShowInNodeList("测试/随机方向(Particle RandomDirection)", "随机方向Particle RandomDirection")]
    public partial class ParticleRandomDirectionControl
    {
        public ParticleRandomDirectionControl()
        {
            InitConstruction();
        }
        ...
        {
            var node = base.Duplicate(param) as ParticleRandomDirectionControl;
