...
{
    [CodeGenerateSystem.ShowInNodeList("测试/测试(Particle 向心运动结点)", "Particle 向心运动结点")]
    public partial class ParticleVelocityByCenterControl
    {
        public ParticleVelocityByCenterControl()
        {
            InitConstruction();
        }
