...
{
    [CodeGenerateSystem.ShowInNodeList("测试/飘带(Particle Trail)", "测试Particle Trail")]
    public partial class ParticleTrailControl
    {
        ...
        {
            var node = base.Duplicate(param) as ParticleTrailControl;
