...
{
    [CodeGenerateSystem.ShowInNodeList("测试/测试(Particle Velocity)", "测试Particle Velocity")]
    public partial class ParticleVelocityControl
    {
        public ParticleVelocityControl()
        {
            InitConstruction();
        }
        ...
        {
            var node = base.Duplicate(param) as ParticleVelocityControl;
