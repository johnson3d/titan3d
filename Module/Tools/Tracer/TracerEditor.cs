...
namespace Tracer
{
    public class TtTracerEditor : IRootForm
    {
        public TtTracerEditor()
        {
        ...
        public unsafe void OnDraw()
        {
            ...
            var result = EngineNS.EGui.UIProxy.DockProxy.BeginMainForm("TracerEditor", this, ImGuiWindowFlags_.ImGuiWindowFlags_None);
            if (result)
            {
