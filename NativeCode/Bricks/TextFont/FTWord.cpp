...
void ITextTexture::UpdateTexture(NxRHI::IGpuDevice* rc, bool bflipV)
{
	if (Dirty == false)
		return;
...
void FTWord::FillVertices(int x, int y, ITextTexture* texture, std::vector<FTVertex>& verts, bool flipV)
{
	x += PixelX;
	y += (FontSize - PixelY);
