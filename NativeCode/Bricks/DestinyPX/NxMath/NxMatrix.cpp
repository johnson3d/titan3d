...
namespace NxMath
{
	struct MatrixVector
	{
		...
		void Test1()
		{
			...
			Matrix2x2 a(Matrix2x2::VectorType(Type(1.0f), Type(0)),
						Matrix2x2::VectorType(Type(0), Type(1.0f)));
			Matrix2x2 b(Matrix2x2::VectorType(Type(0), Type(1)),
						Matrix2x2::VectorType(Type(1), Type(0)));
