...
class TR_CLASS()
	RcNavQuery : public IWeakRefObject
{
public:
...
public:
	...
	bool	GetHeight(const v3dxVector3* pos, const v3dxVector3* pickext, float* h);
	bool	FindStraightPath(const v3dxVector3* start, const v3dxVector3* end, IBlobObject* blob);
