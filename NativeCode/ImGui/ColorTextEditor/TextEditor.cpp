...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::CSharp()
{
	...
	{
		static const char* const cppKeywords[] = {
			"await", "async", "partial", "unsafe", "var", "bool", "break", "case", "catch", "char", "uint", "class",
			"const", "continue", "default", "delete", "do", "double", "else", "enum", "false", "float",
			"for", "foreach", "internal", "goto", "if", "int", "long", "namespace", "new", "null", "operator", "private", "protected", "public",
			"return", "short", "signed", "sizeof", "typeof", "static", "struct", "switch", "where", "this", 
			"throw", "true", "try", "unsigned", "using", "virtual", "override", "void", "while"
		};
		for (auto& k : cppKeywords)
			langDef.mKeywords.insert(k);
