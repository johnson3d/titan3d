...
//-----------------------------------------------------------------------------
struct TR_CLASS(SV_UsingNS = ImGui, SV_RemoveStrings = IMGUI_API, SV_LayoutStruct = 8)
ImGuiStyle
{
...
//-----------------------------------------------------------------------------
struct TR_CLASS(SV_UsingNS = ImGui, SV_RemoveStrings = IMGUI_API)
ImGuiIO
{
    //------------------------------------------------------------------
    ...
    IMGUI_API void  AddInputCharactersUTF8(TR_META(SV_NoStringConverter) const char* str);    // Queue new characters input from an UTF-8 string
...
struct TR_CLASS(SV_UsingNS = ImGui, SV_LayoutStruct = 8, SV_RemoveStrings = IMGUI_API)
...
struct TR_CLASS(SV_UsingNS = ImGui, SV_ReflectAll, SV_RemoveStrings = IMGUI_API)
ImGuiStorage
{
    // [Internal]
...
struct TR_CLASS(SV_UsingNS = ImGui, SV_RemoveStrings = IMGUI_API, SV_LayoutStruct = 4)
ImDrawVert
{
    ImVec2  pos;
    ImVec2  uv;
...
struct TR_CLASS(SV_UsingNS = ImGui, SV_RemoveStrings = IMGUI_API, SV_Dispose = delete self)
ImFontAtlas
{
