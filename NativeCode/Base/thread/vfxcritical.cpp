...
VStringA VCriticalInfoManager::PrintLockInfo()
{
	VStringA str = "Locker Dump Begin:\r\n";
	mManagerLocker.Lock();
...
vfxMTLockerManager vfxMTLockerManager_Instance;
...
{
	vfxMTLockerManager_Instance.Cleanup();
}
