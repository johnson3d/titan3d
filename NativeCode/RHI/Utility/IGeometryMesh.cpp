...
void IVertexArray::ApplyVBs(ICommandList* cmd, IDrawCall* pass, vBOOL bImm)
{
	for (int i = 0; i < VST_Number; i++)
	{
...
vBOOL IGeometryMesh::ApplyGeometry(ICommandList* cmd, IDrawCall* pass, vBOOL bImm)
{
	for (int i = 0; i < VST_Number; i++)
	{
