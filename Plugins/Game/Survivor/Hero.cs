...
namespace Survivor
{
    [EngineNS.Bricks.DataSet.TtDataTable(SheetName = "TtRoleData", HeadRow = 0, DataStartRow = 1)]
    ...
    public class TtHeroManager : EngineNS.Bricks.DataSet.TtDataManager<TtRoleData>
    {
