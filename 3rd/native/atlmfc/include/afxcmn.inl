...
_AFXCMN_INLINE long CRichEditCtrl::FormatRange(_In_opt_ FORMATRANGE* pfr, _In_ BOOL bDisplay)
...
_AFXCMN_INLINE BOOL CRichEditCtrl::SetTargetDevice(_In_opt_ HDC hDC, _In_ long lLineWidth)
