...
namespace xsimd
{
    ...
    template <class B>
    XSIMD_INLINE batch_proxy<B>::batch_proxy(pointer ptr)
        : m_ptr(ptr)
    {
    }

    template <class B>
    XSIMD_INLINE auto batch_proxy<B>::get() -> batch_reference
    {
        return batch_type(*this);
    }

    template <class B>
    XSIMD_INLINE auto batch_proxy<B>::get() const -> const_batch_reference
    {
        return batch_type(*this);
    }

    template <class B>
    XSIMD_INLINE auto batch_proxy<B>::set(const batch_type& rhs) -> self_type&
    {
    ...
    template <class B>
    XSIMD_INLINE auto batch_proxy<B>::set(const self_type& rhs) -> self_type&
    {
    ...
    template <class B>
    XSIMD_INLINE batch_proxy<B>::operator batch_type() const
    {
        batch_type m_reg;
    ...
    template <class B>
    XSIMD_INLINE auto batch_proxy<B>::operator=(const batch_type& rhs) -> batch_proxy&
    {
        xsimd::store_aligned(m_ptr, rhs);
        return *this;
    }
    ...
    template <class B>
    XSIMD_INLINE aligned_iterator<B>::aligned_iterator(pointer memory)
        : m_cur_pointer(memory)
    {
    }

    template <class B>
    XSIMD_INLINE auto aligned_iterator<B>::operator*() -> reference
    {
        return m_cur_pointer;
    }

    template <class B>
    XSIMD_INLINE aligned_iterator<B>& aligned_iterator<B>::operator++()
    {
    ...
    template <class B>
    XSIMD_INLINE void aligned_iterator<B>::operator++(int)
    {
        m_cur_pointer += batch_size;
    }

    template <class B>
    XSIMD_INLINE bool aligned_iterator<B>::equal(const aligned_iterator& rhs) const
    {
        return m_cur_pointer == rhs.m_cur_pointer;
    }

    template <class B>
    XSIMD_INLINE bool operator==(const aligned_iterator<B>& lhs, const aligned_iterator<B>& rhs)
    {
    ...
    template <class B>
    XSIMD_INLINE B fma(const batch_proxy<B>& a, const batch_proxy<B>& b, const batch_proxy<B>& c)
    {
