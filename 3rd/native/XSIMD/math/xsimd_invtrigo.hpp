...
namespace xsimd
{
    namespace detail
    {
        ...
        {
            static XSIMD_INLINE B asin(const B& a)
            {
                B x = abs(a);
                B sign = bitofsign(a);
            ...
            static XSIMD_INLINE B kernel_atan(const B& x, const B& recx)
            {
        ...
        struct invtrigo_kernel
        {
            ...
            static XSIMD_INLINE B acos(const B& a)
            {
                B x = abs(a);
                auto x_larger_05 = x > B(0.5);
            ...
            static XSIMD_INLINE B atan(const B& a)
            {
                const B absa = abs(a);
            ...
            static XSIMD_INLINE B acot(const B& a)
            {
                const B absa = abs(a);
            ...
            static XSIMD_INLINE B atan2(const B& y, const B& x)
            {
                const B q = abs(y / x);
