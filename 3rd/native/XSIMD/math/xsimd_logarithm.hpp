...
namespace xsimd
{
    ...
    template <class B>
    XSIMD_INLINE batch_type_t<B> log(const simd_base<B>& x)
    {
    ...
    template <class B>
    XSIMD_INLINE batch_type_t<B> log2(const simd_base<B>& x)
    {
    ...
    template <class B>
    XSIMD_INLINE batch_type_t<B> log10(const simd_base<B>& x)
    {
    ...
    template <class B>
    XSIMD_INLINE batch_type_t<B> log1p(const simd_base<B>& x)
    {
