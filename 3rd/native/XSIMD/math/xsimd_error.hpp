...
namespace xsimd
{
    ...
    namespace detail
    {
        ...
        struct erf_kernel<B, float>
        {
            ...
            static XSIMD_INLINE B erf1(const B& x)
            {
                return horner<B,
            ...
            // x >=  2/3
            static XSIMD_INLINE B erfc2(const B& x)
            {
                return horner<B,
            ...
            static XSIMD_INLINE B erfc3(const B& x)
            {
        ...
        struct erf_kernel<B, double>
        {
            ...
            // x >=  6 rx = 1/x
            static XSIMD_INLINE B erfc4(const B& x)
            {
                return horner<B,
    ...
    template <class B>
    XSIMD_INLINE batch_type_t<B> erf(const simd_base<B>& x)
    {
    ...
    template <class B>
    XSIMD_INLINE batch_type_t<B> erfc(const simd_base<B>& x)
    {
