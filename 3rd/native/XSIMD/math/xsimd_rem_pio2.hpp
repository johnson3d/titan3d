...
// by vader - compile error in ArmV7
//#include <cmath>
#include <math.h>
#include <cstdint>
#include <cstring>
...
#define SET_LOW_WORD(d, v)                          \
    ...
    ONCE0                                           \
        ...
        XSIMD_INLINE int32_t __kernel_rem_pio2(double* x, double* y, int32_t e0, int32_t nx, int32_t prec, const int32_t* ipio2)
        {
        ...
        XSIMD_INLINE std::int32_t __ieee754_rem_pio2(double x, double* y)
        {
