...
namespace xsimd
{
    ...
    namespace detail
    {
        ...
        {
            static constexpr B maxlog() XSIMD_NOEXCEPT
            {
                return xsimd::maxlog<B>();
            }

            static constexpr B minlog() XSIMD_NOEXCEPT
            {
        ...
        {
            static XSIMD_INLINE B approx(const B& x)
            {
                B y = horner<B,
            ...
            static XSIMD_INLINE B reduce(const B& a, B& x)
            {
        ...
        struct exp_reduction<B, exp_tag, double> : exp_reduction_base<B, exp_tag>
        {
            ...
            static XSIMD_INLINE B reduce(const B& a, B& hi, B& lo, B& x)
            {
                B k = nearbyint(invlog_2<B>() * a);
            ...
            static XSIMD_INLINE B finalize(const B& x, const B& c, const B& hi, const B& lo)
            {
        ...
        struct exp_reduction<B, exp2_tag, double> : exp_reduction_base<B, exp2_tag>
        {
            ...
            static XSIMD_INLINE B reduce(const B& a, B&, B&, B& x)
            {
                B k = nearbyint(a);
                x = (a - k) * log_2<B>();
                return k;
            ...
            static XSIMD_INLINE B finalize(const B& x, const B& c, const B&, const B&)
            {
        ...
        struct exp_reduction<B, exp10_tag, double> : exp_reduction_base<B, exp10_tag>
        {
            ...
            static XSIMD_INLINE B finalize(const B&, const B& c, const B&, const B&)
            {
                return c;
            }
        };
