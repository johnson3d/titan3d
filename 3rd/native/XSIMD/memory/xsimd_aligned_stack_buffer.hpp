...
namespace xsimd
{
    ...
    public:
        ...
        size_type size() const XSIMD_NOEXCEPT;

        reference operator[](size_type);
        const_reference operator[](size_type) const;

        operator pointer() XSIMD_NOEXCEPT;
    ...
    namespace detail
    {
        XSIMD_INLINE void* aligned_alloc_stack(size_t size, size_t alignment)
        {
    ...
    XSIMD_INLINE aligned_stack_buffer<T, A>::aligned_stack_buffer(size_type n)
        : m_size(n)
    {
#ifdef XSIMD_ALLOCA
    ...
    template <class T, size_t A>
    XSIMD_INLINE aligned_stack_buffer<T, A>::~aligned_stack_buffer()
    {
    ...
    template <class T, size_t A>
    XSIMD_INLINE auto aligned_stack_buffer<T, A>::size() const XSIMD_NOEXCEPT -> size_type
    {
        return m_size;
    }
    ...
    template <class T, size_t A>
    XSIMD_INLINE aligned_stack_buffer<T, A>::operator pointer() XSIMD_NOEXCEPT
    {
        return m_ptr;
    }
}
