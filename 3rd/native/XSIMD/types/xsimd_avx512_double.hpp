...
namespace xsimd
{
    ...
    XSIMD_INLINE batch<double, 8>::batch()
    {
    }

    XSIMD_INLINE batch<double, 8>::batch(double d)
        : base_type(_mm512_set1_pd(d))
    {
    }

    XSIMD_INLINE batch<double, 8>::batch(double d0, double d1, double d2, double d3, double d4, double d5, double d6, double d7)
        : base_type(_mm512_setr_pd(d0, d1, d2, d3, d4, d5, d6, d7))
    {
    }

    XSIMD_INLINE batch<double, 8>::batch(const double* src)
        : base_type(_mm512_loadu_pd(src))
    {
    }

    XSIMD_INLINE batch<double, 8>::batch(const double* src, aligned_mode)
        : base_type(_mm512_load_pd(src))
    {
    }

    XSIMD_INLINE batch<double, 8>::batch(const double* src, unaligned_mode)
        : base_type(_mm512_loadu_pd(src))
    {
    }

    XSIMD_INLINE batch<double, 8>::batch(const __m512d& rhs)
        : base_type(rhs)
    {
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::operator=(const __m512d& rhs)
    {
        this->m_value = rhs;
        return *this;
    }

    XSIMD_INLINE batch<double, 8>::operator __m512d() const
    {
        return this->m_value;
    }
    ...
    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_aligned(const int8_t* src)
    {
    ...
    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_unaligned(const int8_t* src)
    {
        return load_aligned(src);
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_aligned(const uint8_t* src)
    {
        __m128i tmp = _mm_loadl_epi64((const __m128i*)src);
    ...
    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_unaligned(const uint8_t* src)
    {
        return load_aligned(src);
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_aligned(const int16_t* src)
    {
    ...
    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_unaligned(const int16_t* src)
    {
    ...
    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_aligned(const uint16_t* src)
    {
        __m128i tmp = _mm_load_si128((const __m128i*)src);
    ...
    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_unaligned(const uint16_t* src)
    {
        __m128i tmp = _mm_loadu_si128((const __m128i*)src);
        __m512i tmp2 = _mm512_cvtepu16_epi64(tmp);
        this->m_value = _mm512_cvtepi64_pd(tmp2);
    ...
    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_aligned(const int32_t* src)
    {
        this->m_value = _mm512_cvtepi32_pd(_mm256_load_si256((__m256i const*)src));
        return *this;
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_unaligned(const int32_t* src)
    {
        this->m_value = _mm512_cvtepi32_pd(_mm256_loadu_si256((__m256i const*)src));
        return *this;
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_aligned(const uint32_t* src)
    {
        this->m_value = _mm512_cvtepu32_pd(_mm256_load_si256((__m256i const*)src));
        return *this;
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_unaligned(const uint32_t* src)
    {
    ...
    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_aligned(const float* src)
    {
        this->m_value = _mm512_cvtps_pd(_mm256_load_ps(src));
        return *this;
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_unaligned(const float* src)
    {
        this->m_value = _mm512_cvtps_pd(_mm256_loadu_ps(src));
        return *this;
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_aligned(const double* src)
    {
        this->m_value = _mm512_load_pd(src);
        return *this;
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::load_unaligned(const double* src)
    {
        this->m_value = _mm512_loadu_pd(src);
        return *this;
    }

    XSIMD_INLINE void batch<double, 8>::store_aligned(int8_t* dst) const
    {
    ...
    XSIMD_INLINE void batch<double, 8>::store_unaligned(int8_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 8>::store_aligned(uint8_t* dst) const
    {
        __m512i tmp = _mm512_cvtpd_epi64(this->m_value);
    ...
    XSIMD_INLINE void batch<double, 8>::store_unaligned(uint8_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 8>::store_aligned(int16_t* dst) const
    {
        __m512i tmp = _mm512_cvtpd_epi64(this->m_value);
    ...
    XSIMD_INLINE void batch<double, 8>::store_unaligned(int16_t* dst) const
    {
        __m512i tmp = _mm512_cvtpd_epi64(this->m_value);
        __m128i tmp2 = _mm512_cvtepi64_epi16(tmp);
    ...
    XSIMD_INLINE void batch<double, 8>::store_aligned(uint16_t* dst) const
    {
        __m512i tmp = _mm512_cvtpd_epi64(this->m_value);
    ...
    XSIMD_INLINE void batch<double, 8>::store_unaligned(uint16_t* dst) const
    {
        __m512i tmp = _mm512_cvtpd_epi64(this->m_value);
        __m128i tmp2 = _mm512_cvtusepi64_epi16(tmp);
        _mm_storeu_si128((__m128i*)dst, tmp2);
    ...
    XSIMD_INLINE void batch<double, 8>::store_aligned(int32_t* dst) const
    {
        _mm256_store_si256((__m256i*)dst, _mm512_cvtpd_epi32(this->m_value));
    }

    XSIMD_INLINE void batch<double, 8>::store_unaligned(int32_t* dst) const
    {
        _mm256_storeu_si256((__m256i*)dst, _mm512_cvtpd_epi32(this->m_value));
    }

    XSIMD_INLINE void batch<double, 8>::store_aligned(uint32_t* dst) const
    {
        _mm256_store_si256((__m256i*)dst, _mm512_cvtpd_epu32(this->m_value));
    }

    XSIMD_INLINE void batch<double, 8>::store_unaligned(uint32_t* dst) const
    {
        _mm256_storeu_si256((__m256i*)dst, _mm512_cvtpd_epu32(this->m_value));
    }

    XSIMD_INLINE void batch<double, 8>::store_aligned(float* dst) const
    {
        _mm256_store_ps(dst, _mm512_cvtpd_ps(this->m_value));
    }

    XSIMD_INLINE void batch<double, 8>::store_unaligned(float* dst) const
    {
        _mm256_storeu_ps(dst, _mm512_cvtpd_ps(this->m_value));
    }

    XSIMD_INLINE void batch<double, 8>::store_aligned(double* dst) const
    {
        _mm512_store_pd(dst, this->m_value);
    }

    XSIMD_INLINE void batch<double, 8>::store_unaligned(double* dst) const
    {
...
#undef step1
    ...
    XSIMD_INLINE batch<double, 8>::batch(const batch_bool<double, 8>& rhs)
        : base_type(detail::batch_kernel<double, 8>::select(rhs, batch(double(1)), batch(double(0))))
    {
    }

    XSIMD_INLINE batch<double, 8>& batch<double, 8>::operator=(const batch_bool<double, 8>& rhs)
    {
