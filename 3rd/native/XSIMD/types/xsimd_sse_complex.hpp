...
namespace xsimd
{
    ...
    XSIMD_INLINE batch<std::complex<float>, 4>&
    ...
    XSIMD_INLINE auto batch<std::complex<float>, 4>::get_complex_high() const -> real_batch
    {
        return _mm_unpacklo_ps(this->m_real, this->m_imag);
    }

    XSIMD_INLINE auto batch<std::complex<float>, 4>::get_complex_low() const -> real_batch
    {
        return _mm_unpackhi_ps(this->m_real, this->m_imag);
    }

    XSIMD_INLINE batch<std::complex<double>, 2>&
    ...
    XSIMD_INLINE auto batch<std::complex<double>, 2>::get_complex_high() const -> real_batch
    {
        return _mm_unpacklo_pd(this->m_real, this->m_imag);
    }

    XSIMD_INLINE auto batch<std::complex<double>, 2>::get_complex_low() const -> real_batch
    {
    ...
    template <bool i3ec>
    XSIMD_INLINE batch<xtl::xcomplex<float, float, i3ec>, 4>&
    ...
    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<float, float, i3ec>, 4>::get_complex_high() const -> real_batch
    {
        return _mm_unpacklo_ps(this->m_real, this->m_imag);
    }

    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<float, float, i3ec>, 4>::get_complex_low() const -> real_batch
    {
        return _mm_unpackhi_ps(this->m_real, this->m_imag);
    }

    template <bool i3ec>
    XSIMD_INLINE batch<xtl::xcomplex<double, double, i3ec>, 2>&
    ...
    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<double, double, i3ec>, 2>::get_complex_high() const -> real_batch
    {
        return _mm_unpacklo_pd(this->m_real, this->m_imag);
    }

    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<double, double, i3ec>, 2>::get_complex_low() const -> real_batch
    {
        return _mm_unpackhi_pd(this->m_real, this->m_imag);
    }
