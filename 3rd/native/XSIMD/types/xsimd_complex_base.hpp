...
namespace xsimd
{
     ...
     */
    template <class X>
    XSIMD_INLINE simd_complex_batch_bool<X>::simd_complex_batch_bool(bool b)
        : m_value(b)
    {
    }
     ...
     */
    template <class X>
    XSIMD_INLINE simd_complex_batch_bool<X>::simd_complex_batch_bool(const real_batch& b)
        : m_value(b)
    {
    }

    template <class X>
    XSIMD_INLINE auto simd_complex_batch_bool<X>::value() const -> const real_batch&
    {
        return m_value;
    }

    template <class X>
    XSIMD_INLINE bool simd_complex_batch_bool<X>::operator[](std::size_t index) const
    {
     ...
     */
    template <class X>
    XSIMD_INLINE simd_complex_batch<X>::simd_complex_batch(const value_type& v)
     ...
     */
    template <class X>
    XSIMD_INLINE simd_complex_batch<X>::simd_complex_batch(const real_value_type& v)
     ...
     */
    template <class X>
    XSIMD_INLINE simd_complex_batch<X>::simd_complex_batch(const real_batch& re)
     ...
     */
    template <class X>
    XSIMD_INLINE simd_complex_batch<X>::simd_complex_batch(const real_batch& re, const real_batch& im)
        : m_real(re), m_imag(im)
    {
    }
     ...
     */
    template <class X>
    XSIMD_INLINE auto simd_complex_batch<X>::real() -> real_batch&
    {
        return m_real;
    }
     ...
     */
    template <class X>
    XSIMD_INLINE auto simd_complex_batch<X>::imag() -> real_batch&
    {
        return m_imag;
    }
     ...
     */
    template <class X>
    XSIMD_INLINE auto simd_complex_batch<X>::real() const -> const real_batch&
    {
        return m_real;
    }
     ...
     */
    template <class X>
    XSIMD_INLINE auto simd_complex_batch<X>::imag() const -> const real_batch&
    {
        return m_imag;
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X& simd_complex_batch<X>::operator+=(const X& rhs)
    {
        m_real += rhs.real();
        m_imag += rhs.imag();
        return (*this)();
     ...
     */
    template <class X>
    XSIMD_INLINE X& simd_complex_batch<X>::operator+=(const value_type& rhs)
    {
        return (*this)() += X(rhs);
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X& simd_complex_batch<X>::operator+=(const real_batch& rhs)
    {
        m_real += rhs;
        return (*this)();
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X& simd_complex_batch<X>::operator+=(const real_value_type& rhs)
    {
    ...
    namespace detail
    {
        ...
        struct complex_batch_multiplier
        {
            ...
            XSIMD_INLINE static X mul(const X& lhs, const X& rhs)
            {
            ...
            XSIMD_INLINE static X div(const X& lhs, const X& rhs)
            {
                real_batch a = lhs.real();
                real_batch b = lhs.imag();
                real_batch c = rhs.real();
    ...
    template <class X>
    template <class T>
    XSIMD_INLINE X& simd_complex_batch<X>::load_aligned(const T* real_src, const T* imag_src)
    {
    ...
    template <class X>
    template <class T>
    XSIMD_INLINE X& simd_complex_batch<X>::load_unaligned(const T* real_src, const T* imag_src)
    {
    ...
    template <class X>
    template <class T>
    XSIMD_INLINE void simd_complex_batch<X>::store_aligned(T* real_dst, T* imag_dst) const
    {
    ...
    template <class X>
    template <class T>
    XSIMD_INLINE void simd_complex_batch<X>::store_unaligned(T* real_dst, T* imag_dst) const
    {
    ...
    template <class X>
    template <class T>
    XSIMD_INLINE typename std::enable_if<detail::is_complex<T>::value, X&>::type
    ...
    template <class X>
    template <class T>
    XSIMD_INLINE void simd_complex_batch<X>::store_aligned(T* dst) const
    {
    ...
    template <class X>
    template <class T>
    XSIMD_INLINE void simd_complex_batch<X>::store_unaligned(T* dst) const
    {
        real_batch hi = (*this)().get_complex_high();
        real_batch lo = (*this)().get_complex_low();
        using tmp_value_type = typename T::value_type;
    ...
    template <class X>
    XSIMD_INLINE auto simd_complex_batch<X>::operator[](std::size_t index) const -> value_type
    {
        return value_type(m_real[index], m_imag[index]);
    }

    template <class X>
    XSIMD_INLINE auto simd_complex_batch<X>::get() -> batch_reference
    {
        return this->derived_cast();
    }

    template <class X>
    XSIMD_INLINE auto simd_complex_batch<X>::get() const -> const_batch_reference
    {
        return this->derived_cast();
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X operator-(const simd_complex_batch<X>& rhs)
    {
     ...
     */
    template <class X>
    XSIMD_INLINE X operator+(const simd_complex_batch<X>& lhs, const simd_complex_batch<X>& rhs)
    {
        X tmp(lhs());
        return tmp += rhs();
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X operator+(const simd_complex_batch<X>& lhs, const typename simd_batch_traits<X>::value_type& rhs)
    {
        X tmp(lhs());
        return tmp += X(rhs);
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X operator+(const typename simd_batch_traits<X>::value_type& lhs, const simd_complex_batch<X>& rhs)
    {
        X tmp(lhs);
        return tmp += rhs();
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X operator+(const simd_complex_batch<X>& lhs, const typename simd_batch_traits<X>::real_batch& rhs)
    {
        X tmp(lhs());
        return tmp += X(rhs);
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X operator+(const typename simd_batch_traits<X>::real_batch& lhs, const simd_complex_batch<X>& rhs)
    {
        X tmp(lhs);
        return tmp += rhs();
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X operator+(const simd_complex_batch<X>& lhs, const typename simd_batch_traits<X>::real_value_type& rhs)
    {
        X tmp(lhs());
        return tmp += X(rhs);
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X operator+(const typename simd_batch_traits<X>::real_value_type& lhs, const simd_complex_batch<X>& rhs)
    {
        X tmp(lhs);
        return tmp += rhs();
    }
    ...
    */
    template <class X>
    XSIMD_INLINE X select(const typename simd_batch_traits<X>::batch_bool_type& cond,
                    const simd_complex_batch<X>& a,
                    const simd_complex_batch<X>& b)
    {
     ...
     */
    template <class X>
    XSIMD_INLINE std::ostream& operator<<(std::ostream& out, const simd_complex_batch<X>& rhs)
    {
        out << '(';
