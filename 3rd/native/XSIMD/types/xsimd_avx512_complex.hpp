...
namespace xsimd
{
    ...
    XSIMD_INLINE batch<std::complex<float>, 16>&
    ...
    XSIMD_INLINE auto batch<std::complex<float>, 16>::get_complex_high() const -> real_batch
    {
    ...
    XSIMD_INLINE auto batch<std::complex<float>, 16>::get_complex_low() const -> real_batch
    {
        __m512i idx = _mm512_setr_epi32(8, 24, 9, 25, 10, 26, 11, 27, 12, 28, 13, 29, 14, 30, 15, 31);
        return _mm512_permutex2var_ps(this->m_real, idx, this->m_imag);
    }

    XSIMD_INLINE batch<std::complex<double>, 8>&
    ...
    XSIMD_INLINE auto batch<std::complex<double>, 8>::get_complex_high() const -> real_batch
    {
        __m512i idx = _mm512_setr_epi64(0, 8, 1, 9, 2, 10, 3, 11);
        return _mm512_permutex2var_pd(this->m_real, idx, this->m_imag);
    }

    XSIMD_INLINE auto batch<std::complex<double>, 8>::get_complex_low() const -> real_batch
    {
    ...
    template <bool i3ec>
    XSIMD_INLINE batch<xtl::xcomplex<float, float, i3ec>, 16>&
    ...
    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<float, float, i3ec>, 16>::get_complex_high() const -> real_batch
    {
        __m512i idx = _mm512_setr_epi32(0, 16, 1, 17, 2, 18, 3, 19, 4, 20, 5, 21, 6, 22, 7, 23);
        return _mm512_permutex2var_ps(this->m_real, idx, this->m_imag);
    }
    ...
    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<float, float, i3ec>, 16>::get_complex_low() const -> real_batch
    {
        __m512i idx = _mm512_setr_epi32(8, 24, 9, 25, 10, 26, 11, 27, 12, 28, 13, 29, 14, 30, 15, 31);
        return _mm512_permutex2var_ps(this->m_real, idx, this->m_imag);
    }
    ...
    template <bool i3ec>
    XSIMD_INLINE batch<xtl::xcomplex<double, double, i3ec>, 8>&
    ...
    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<double, double, i3ec>, 8>::get_complex_high() const -> real_batch
    {
        __m512i idx = _mm512_setr_epi64(0, 8, 1, 9, 2, 10, 3, 11);
        return _mm512_permutex2var_pd(this->m_real, idx, this->m_imag);
    }
    ...
    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<double, double, i3ec>, 8>::get_complex_low() const -> real_batch
    {
        __m512i idx = _mm512_setr_epi64(4, 12, 5, 13, 6, 14, 7, 15);
        return _mm512_permutex2var_pd(this->m_real, idx, this->m_imag);
    }
