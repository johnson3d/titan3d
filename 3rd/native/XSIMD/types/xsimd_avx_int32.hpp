...
namespace xsimd
{
    ...
    XSIMD_INLINE batch<int32_t, 8>& batch<int32_t, 8>::load_aligned(const float* src)
    {
        this->m_value = _mm256_cvtps_epi32(_mm256_load_ps(src));
        return *this;
    }

    XSIMD_INLINE batch<int32_t, 8>& batch<int32_t, 8>::load_unaligned(const float* src)
    {
        this->m_value = _mm256_cvtps_epi32(_mm256_loadu_ps(src));
        return *this;
    }

    XSIMD_INLINE void batch<int32_t, 8>::store_aligned(float* dst) const
    {
        _mm256_store_ps(dst, _mm256_cvtepi32_ps(this->m_value));
    }

    XSIMD_INLINE void batch<int32_t, 8>::store_unaligned(float* dst) const
    {
...
#undef AVX_DEFINE_LOAD_STORE_INT32
    ...
    XSIMD_INLINE batch<int32_t, 8> operator<<(const batch<int32_t, 8>& lhs, int32_t rhs)
    {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
    ...
    XSIMD_INLINE batch<int32_t, 8> operator<<(const batch<int32_t, 8>& lhs, const batch<int32_t, 8>& rhs)
    {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
    ...
    XSIMD_INLINE batch<uint32_t, 8> operator<<(const batch<uint32_t, 8>& lhs, int32_t rhs)
    {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
        return _mm256_slli_epi32(lhs, rhs);
#else
    ...
    XSIMD_INLINE batch<uint32_t, 8> operator<<(const batch<uint32_t, 8>& lhs, const batch<int32_t, 8>& rhs)
    {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
        return _mm256_sllv_epi32(lhs, rhs);
#else
