...
namespace xsimd
{
    ...
    XSIMD_INLINE batch<double, 2>::batch()
    {
    }

    XSIMD_INLINE batch<double, 2>::batch(double d)
        : base_type(vdupq_n_f64(d))
    {
    }

    XSIMD_INLINE batch<double, 2>::batch(double d1, double d2)
        : base_type(storage_type{ d1, d2 })
    {
    }

    XSIMD_INLINE batch<double, 2>::batch(const double* d)
        : base_type(vld1q_f64(d))
    {
    }

    XSIMD_INLINE batch<double, 2>::batch(const double* d, aligned_mode)
        : batch(d)
    {
    }

    XSIMD_INLINE batch<double, 2>::batch(const double* d, unaligned_mode)
        : batch(d)
    {
    }

    XSIMD_INLINE batch<double, 2>::batch(const storage_type& rhs)
        : base_type(rhs)
    {
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::operator=(const storage_type& rhs)
    {
        this->m_value = rhs;
        return *this;
    }

    XSIMD_INLINE batch<double, 2>::batch(const batch_bool_type& rhs)
        : base_type(vreinterpretq_f64_u64(vandq_u64(rhs,
                                                    vreinterpretq_u64_f64(batch(1.)))))
    {
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::operator=(const batch_bool_type& rhs)
    {
    ...
    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const int8_t* src)
    {
    ...
    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const int8_t* src)
    {
        return load_aligned(src);
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const uint8_t* src)
    {
    ...
    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const uint8_t* src)
    {
        return load_aligned(src);
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const int16_t* src)
    {
    ...
    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const int16_t* src)
    {
        return load_aligned(src);
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const uint16_t* src)
    {
    ...
    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const uint16_t* src)
    {
        return load_aligned(src);
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const int32_t* d)
    {
        this->m_value = vcvt_f64_f32(vcvt_f32_s32(vld1_s32(d)));
        return *this;
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const int32_t* d)
    {
        return load_aligned(d);
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const uint32_t* d)
    {
        this->m_value = vcvt_f64_f32(vcvt_f32_u32(vld1_u32(d)));
        return *this;
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const uint32_t* d)
    {
        return load_aligned(d);
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const int64_t* d)
    {
        this->m_value = vcvtq_f64_s64(vld1q_s64(d));
        return *this;
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const int64_t* d)
    {
        return load_aligned(d);
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const uint64_t* d)
    {
        this->m_value = vcvtq_f64_u64(vld1q_u64(d));
        return *this;
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const uint64_t* d)
    {
        return load_aligned(d);
    }
    ...
    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const float* d)
    {
        this->m_value = vcvt_f64_f32(vld1_f32(d));
        return *this;
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const float* d)
    {
        return load_aligned(d);
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_aligned(const double* d)
    {
        this->m_value = vld1q_f64(d);
        return *this;
    }

    XSIMD_INLINE batch<double, 2>& batch<double, 2>::load_unaligned(const double* d)
    {
        return load_aligned(d);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(int8_t* dst) const
    {
    ...
    XSIMD_INLINE void batch<double, 2>::store_unaligned(int8_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(uint8_t* dst) const
    {
        float32x2_t tmp = vcvt_f32_f64(this->m_value);
    ...
    XSIMD_INLINE void batch<double, 2>::store_unaligned(uint8_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(int16_t* dst) const
    {
        float32x2_t tmp = vcvt_f32_f64(this->m_value);
        int32x2_t tmp2 = vcvtn_s32_f32(tmp);
        int32x4_t tmp3 = vcombine_s32(tmp2, vdup_n_s32(0));
    ...
    XSIMD_INLINE void batch<double, 2>::store_unaligned(int16_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(uint16_t* dst) const
    {
        float32x2_t tmp = vcvt_f32_f64(this->m_value);
        uint32x2_t tmp2 = vcvtn_u32_f32(tmp);
        uint32x4_t tmp3 = vcombine_u32(tmp2, vdup_n_u32(0));
    ...
    XSIMD_INLINE void batch<double, 2>::store_unaligned(uint16_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(int32_t* dst) const
    {
    ...
    XSIMD_INLINE void batch<double, 2>::store_unaligned(int32_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(uint32_t* dst) const
    {
#if XSIMD_ARM_INSTR_SET >= XSIMD_ARM8_64_NEON_VERSION
    ...
    XSIMD_INLINE void batch<double, 2>::store_unaligned(uint32_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(int64_t* dst) const
    {
#if XSIMD_ARM_INSTR_SET >= XSIMD_ARM8_64_NEON_VERSION
    ...
    XSIMD_INLINE void batch<double, 2>::store_unaligned(int64_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(uint64_t* dst) const
    {
#if XSIMD_ARM_INSTR_SET >= XSIMD_ARM8_64_NEON_VERSION
    ...
    XSIMD_INLINE void batch<double, 2>::store_unaligned(uint64_t* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(float* dst) const
    {
#if XSIMD_ARM_INSTR_SET >= XSIMD_ARM8_64_NEON_VERSION
    ...
    XSIMD_INLINE void batch<double, 2>::store_unaligned(float* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE void batch<double, 2>::store_aligned(double* dst) const
    {
        vst1q_f64(dst, m_value);
    }

    XSIMD_INLINE void batch<double, 2>::store_unaligned(double* dst) const
    {
        store_aligned(dst);
    }

    XSIMD_INLINE batch<double, 2>::operator float64x2_t() const
    {
        return this->m_value;
    }
