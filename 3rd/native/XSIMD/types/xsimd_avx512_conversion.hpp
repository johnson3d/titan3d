...
namespace xsimd
{
    ...
    XSIMD_INLINE batch<int32_t, 16> to_int(const batch<float, 16>& x)
    {
        return _mm512_cvttps_epi32(x);
    }

    XSIMD_INLINE batch<int64_t, 8> to_int(const batch<double, 8>& x)
    {
    ...
    XSIMD_INLINE batch<float, 16> to_float(const batch<int32_t, 16>& x)
    {
        return _mm512_cvtepi32_ps(x);
    }

    XSIMD_INLINE batch<double, 8> to_float(const batch<int64_t, 8>& x)
    {
#if defined(XSIMD_AVX512DQ_AVAILABLE)
    ...
    XSIMD_INLINE batch_bool<int32_t, 16> bool_cast(const batch_bool<float, 16>& x)
    {
        return __mmask16(x);
    }

    XSIMD_INLINE batch_bool<int64_t, 8> bool_cast(const batch_bool<double, 8>& x)
    {
        return __mmask8(x);
    }

    XSIMD_INLINE batch_bool<float, 16> bool_cast(const batch_bool<int32_t, 16>& x)
    {
        return __mmask16(x);
    }

    XSIMD_INLINE batch_bool<double, 8> bool_cast(const batch_bool<int64_t, 8>& x)
    {
        return __mmask8(x);
    }
