...
#define XSIMD_APPLY_AVX2_FUNCTION_INT16(func, avx_lhs, avx_rhs) \
    ...
    XSIMD_INLINE batch<int16_t, 32> operator<<(const batch<int16_t, 32>& lhs, int32_t rhs)
    {
#if defined(XSIMD_AVX512BW_AVAILABLE)
    ...
    XSIMD_INLINE batch<int16_t, 32> operator<<(const batch<int16_t, 32>& lhs, const batch<int16_t, 32>& rhs)
    {
#if defined(XSIMD_AVX512BW_AVAILABLE)
    ...
    XSIMD_INLINE batch<uint16_t, 32> operator<<(const batch<uint16_t, 32>& lhs, int32_t rhs)
    {
#if defined(XSIMD_AVX512BW_AVAILABLE)
#if defined(XSIMD_AVX512_SHIFT_INTRINSICS_IMM_ONLY)
        return _mm512_sllv_epi16(lhs, _mm512_set1_epi16(rhs));
    ...
    XSIMD_INLINE batch<uint16_t, 32> operator<<(const batch<uint16_t, 32>& lhs, const batch<int16_t, 32>& rhs)
    {
#if defined(XSIMD_AVX512BW_AVAILABLE)
        return _mm512_sllv_epi16(lhs, rhs);
#else
