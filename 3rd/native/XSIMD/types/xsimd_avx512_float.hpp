...
namespace xsimd
{
    ...
    XSIMD_INLINE batch<float, 16>::batch(float i)
        : base_type(_mm512_set1_ps(i))
    {
    }

    XSIMD_INLINE batch<float, 16>::batch(float i0, float i1,  float i2,  float i3,  float i4,  float i5,  float i6,  float i7,
                                   float i8, float i9, float i10, float i11, float i12, float i13, float i14, float i15)
        : base_type(_mm512_setr_ps(i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15))
    {
    }

    XSIMD_INLINE batch<float, 16>::batch(const float* src)
        : base_type(_mm512_loadu_ps(src))
    {
    }

    XSIMD_INLINE batch<float, 16>::batch(const float* src, aligned_mode)
        : base_type(_mm512_load_ps(src))
    {
    }

    XSIMD_INLINE batch<float, 16>::batch(const float* src, unaligned_mode)
        : base_type(_mm512_loadu_ps(src))
    {
    }

    XSIMD_INLINE batch<float, 16>::batch(const __m512& rhs)
        : base_type(rhs)
    {
    }

    XSIMD_INLINE batch<float, 16>& batch<float, 16>::operator=(const __m512& rhs)
    {
        this->m_value = rhs;
        return *this;
    }

    XSIMD_INLINE batch<float, 16>::operator __m512() const
    {
        return this->m_value;
    }
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_aligned(const int8_t* src)
    {
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_unaligned(const int8_t* src)
    {
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_aligned(const uint8_t* src)
    {
        __m128i tmp = _mm_load_si128((const __m128i*)src);
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_unaligned(const uint8_t* src)
    {
        __m128i tmp = _mm_loadu_si128((const __m128i*)src);
        __m512i tmp2 = _mm512_cvtepu8_epi32(tmp);
        this->m_value = _mm512_cvtepi32_ps(tmp2);
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_aligned(const int16_t* src)
    {
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_unaligned(const int16_t* src)
    {
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_aligned(const uint16_t* src)
    {
        __m256i tmp = _mm256_load_si256((const __m256i*)src);
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_unaligned(const uint16_t* src)
    {
        __m256i tmp = _mm256_loadu_si256((const __m256i*)src);
        __m512i tmp2 = _mm512_cvtepu16_epi32(tmp);
        this->m_value = _mm512_cvtepi32_ps(tmp2);
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_aligned(const int32_t* src)
    {
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_unaligned(const int32_t* src)
    {
        this->m_value = _mm512_cvt_roundepi32_ps(_mm512_loadu_si512(src), _MM_FROUND_CUR_DIRECTION);
        return *this;
    }

    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_aligned(const uint32_t* src)
    {
        // TODO select correct rounding direction?
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_unaligned(const uint32_t* src)
    {
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_aligned(const float* src)
    {
        this->m_value = _mm512_load_ps(src);
        return *this;
    }

    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_unaligned(const float* src)
    {
        this->m_value = _mm512_loadu_ps(src);
        return *this;
    }

    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_aligned(const double* src)
    {
    ...
    XSIMD_INLINE batch<float, 16>& batch<float, 16>::load_unaligned(const double* src)
    {
    ...
    XSIMD_INLINE void batch<float, 16>::store_aligned(int8_t* dst) const
    {
    ...
    XSIMD_INLINE void batch<float, 16>::store_unaligned(int8_t* dst) const
    {
        __m512i tmp = _mm512_cvtps_epi32(this->m_value);
        __m128i tmp2 = _mm512_cvtepi32_epi8(tmp);
    ...
    XSIMD_INLINE void batch<float, 16>::store_aligned(uint8_t* dst) const
    {
    ...
    XSIMD_INLINE void batch<float, 16>::store_unaligned(uint8_t* dst) const
    {
        __m512i tmp = _mm512_cvtps_epu32(this->m_value);
        __m128i tmp2 = _mm512_cvtusepi32_epi8(tmp);
        _mm_storeu_si128((__m128i*)dst, tmp2);
    ...
    XSIMD_INLINE void batch<float, 16>::store_aligned(int16_t* dst) const
    {
        __m512i tmp = _mm512_cvtps_epi32(this->m_value);
    ...
    XSIMD_INLINE void batch<float, 16>::store_unaligned(int16_t* dst) const
    {
        __m512i tmp = _mm512_cvtps_epi32(this->m_value);
        __m256i tmp2 = _mm512_cvtepi32_epi16(tmp);
    ...
    XSIMD_INLINE void batch<float, 16>::store_aligned(uint16_t* dst) const
    {
        __m512i tmp = _mm512_cvtps_epu32(this->m_value);
    ...
    XSIMD_INLINE void batch<float, 16>::store_unaligned(uint16_t* dst) const
    {
        __m512i tmp = _mm512_cvtps_epu32(this->m_value);
        __m256i tmp2 = _mm512_cvtusepi32_epi16(tmp);
        _mm256_storeu_si256((__m256i*)dst, tmp2);
    ...
    XSIMD_INLINE void batch<float, 16>::store_aligned(int32_t* dst) const
    {
        _mm512_store_si512((__m512i *)dst, _mm512_cvtps_epi32(this->m_value));
    }

    XSIMD_INLINE void batch<float, 16>::store_unaligned(int32_t* dst) const
    {
        _mm512_storeu_si512((__m512i *)dst, _mm512_cvtps_epi32(this->m_value));
    }

    XSIMD_INLINE void batch<float, 16>::store_aligned(uint32_t* dst) const
    {
        _mm512_store_si512((__m512i *)dst, _mm512_cvtps_epu32(this->m_value));
    }

    XSIMD_INLINE void batch<float, 16>::store_unaligned(uint32_t* dst) const
    {
        _mm512_storeu_si512((__m512i *)dst, _mm512_cvtps_epu32(this->m_value));
    }

    XSIMD_INLINE void batch<float, 16>::store_aligned(float* dst) const
    {
        _mm512_store_ps(dst, this->m_value);
    }

    XSIMD_INLINE void batch<float, 16>::store_unaligned(float* dst) const
    {
        _mm512_storeu_ps(dst, this->m_value);
    }

    XSIMD_INLINE void batch<float, 16>::store_aligned(double* dst) const
    {
    ...
    XSIMD_INLINE void batch<float, 16>::store_unaligned(double* dst) const
    {
...
#undef XSIMD_AVX512_HADDP_STEP2
    ...
    XSIMD_INLINE batch<float, 16>::batch(const batch_bool<float, 16>& rhs)
        : base_type(detail::batch_kernel<float, 16>::select(rhs, batch(float(1)), batch(float(0))))
    {
    }

    XSIMD_INLINE batch<float, 16>& batch<float, 16>::operator=(const batch_bool<float, 16>& rhs)
    {
