...
namespace xsimd
{
    ...
    {
        template <class B>
        XSIMD_INLINE std::pair<B, B> load_complex_f(const B& hi, const B& lo)
        {
        ...
        XSIMD_INLINE B get_half_complex_f(const B& real, const B& imag)
        {
        ...
        template <class B>
        XSIMD_INLINE B get_complex_high_f(const B& real, const B& imag)
        {
            return get_half_complex_f<0>(real, imag);
        }

        template <class B>
        XSIMD_INLINE B get_complex_low_f(const B& real, const B& imag)
        {
            return get_half_complex_f<1>(real, imag);
        }

        template <class B>
        XSIMD_INLINE std::pair<B, B> load_complex_d(const B& hi, const B& lo)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
        ...
        // which require index parameter to be a constant
        template <int index, class B>
        XSIMD_INLINE B get_half_complex_d(const B& real, const B& imag)
        {
        ...
        template <class B>
        XSIMD_INLINE B get_complex_high_d(const B& real, const B& imag)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
        ...
        template <class B>
        XSIMD_INLINE B get_complex_low_d(const B& real, const B& imag)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
    ...
    XSIMD_INLINE batch<std::complex<float>, 8>&
    ...
    XSIMD_INLINE auto batch<std::complex<float>, 8>::get_complex_high() const -> real_batch
    {
        return detail::get_complex_high_f(this->m_real, this->m_imag);
    }

    XSIMD_INLINE auto batch<std::complex<float>, 8>::get_complex_low() const -> real_batch
    {
        return detail::get_complex_low_f(this->m_real, this->m_imag);
    }

    XSIMD_INLINE batch<std::complex<double>, 4>&
    ...
    XSIMD_INLINE auto batch<std::complex<double>, 4>::get_complex_high() const -> real_batch
    {
        return detail::get_complex_high_d(this->m_real, this->m_imag);
    }

    XSIMD_INLINE auto batch<std::complex<double>, 4>::get_complex_low() const -> real_batch
    {
    ...
    template <bool i3ec>
    XSIMD_INLINE batch<xtl::xcomplex<float, float, i3ec>, 8>&
    ...
    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<float, float, i3ec>, 8>::get_complex_high() const -> real_batch
    {
        return detail::get_complex_high_f(this->m_real, this->m_imag);
    }

    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<float, float, i3ec>, 8>::get_complex_low() const -> real_batch
    {
        return detail::get_complex_low_f(this->m_real, this->m_imag);
    }

    template <bool i3ec>
    XSIMD_INLINE batch<xtl::xcomplex<double, double, i3ec>, 4>&
    ...
    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<double, double, i3ec>, 4>::get_complex_high() const -> real_batch
    {
        return detail::get_complex_high_d(this->m_real, this->m_imag);
    }

    template <bool i3ec>
    XSIMD_INLINE auto batch<xtl::xcomplex<double, double, i3ec>, 4>::get_complex_low() const -> real_batch
    {
        return detail::get_complex_low_d(this->m_real, this->m_imag);
    }
