...
namespace xsimd
{
    namespace detail
    {
        ...
        XSIMD_INLINE __m256i xsimd_cvtepi8_epi32(__m128i a)
        {
        ...
        XSIMD_INLINE __m256i xsimd_cvtepu8_epi32(__m128i a)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
        ...
        XSIMD_INLINE __m128i xsimd_cvtepi32_epi8(__m256i a)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
        ...
        XSIMD_INLINE __m128i xsimd_cvtepi32_epu8(__m256i a)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
            __m256i tmp2 = _mm256_packs_epi32(a, a);
            __m256i tmp3 = _mm256_permute4x64_epi64(tmp2, _MM_SHUFFLE(3, 1, 2, 0));
        ...
        XSIMD_INLINE __m256i xsimd_cvtepi16_epi32(__m128i a)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
        ...
        XSIMD_INLINE __m256i xsimd_cvtepu16_epi32(__m128i a)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
        ...
        XSIMD_INLINE __m128i xsimd_cvtepi32_epi16(__m256i a)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
        ...
        XSIMD_INLINE __m128i xsimd_cvtepi32_epu16(__m256i a)
        {
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
