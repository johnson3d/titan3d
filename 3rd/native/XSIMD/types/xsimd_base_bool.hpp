...
namespace xsimd
{
    ...
    template <class T>
    XSIMD_INLINE bool_proxy<T>::bool_proxy(T& ref)
        : m_ref(ref)
    {
    }

    template <class T>
    XSIMD_INLINE bool_proxy<T>& bool_proxy<T>::operator=(bool rhs)
    {
    ...
    template <class T>
    XSIMD_INLINE bool_proxy<T>::operator bool() const
    {
     ...
     */
    template <class X>
    XSIMD_INLINE X& simd_batch_bool<X>::operator&=(const X& rhs)
    {
        (*this)() = (*this)() & rhs;
        return (*this)();
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X& simd_batch_bool<X>::operator()()
    {
    ...
    template <class X>
    XSIMD_INLINE X& simd_batch_bool<X>::load_aligned(const bool* src)
    {
        return load_impl(detail::make_index_sequence<size>(), src);
    }

    template <class X>
    XSIMD_INLINE X& simd_batch_bool<X>::load_unaligned(const bool* src)
    {
        return load_aligned(src);
    }

    template <class X>
    XSIMD_INLINE void simd_batch_bool<X>::store_aligned(bool* dst) const
    {
        store_impl(dst);
    }

    template <class X>
    XSIMD_INLINE void simd_batch_bool<X>::store_unaligned(bool* dst) const
    {
        store_impl(dst);
    }
    ...
    template <class X>
    template <class P>
    XSIMD_INLINE X& simd_batch_bool<X>::load_aligned(const P& src)
    {
        return load_impl(detail::make_index_sequence<size>(), src);
    }
    ...
    template <class X>
    template <class P>
    XSIMD_INLINE X& simd_batch_bool<X>::load_unaligned(const P& src)
    {
        return load_aligned(src);
    }   
    ...
    template <class X>
    template <class P>
    XSIMD_INLINE void simd_batch_bool<X>::store_aligned(P& dst) const
    {
        store_impl(dst);
    }
    ...
    template <class X>
    template <class P>
    XSIMD_INLINE void simd_batch_bool<X>::store_unaligned(P& dst) const
    {
        store_impl(dst);
    }
    ...
    template <class X>
    template <class P, std::size_t... I>
    XSIMD_INLINE X& simd_batch_bool<X>::load_impl(detail::index_sequence<I...>, const P& src)
    {
    ...
    template <class X>
    template <class P>
    XSIMD_INLINE void simd_batch_bool<X>::store_impl(P& dst) const
    {
    ...
    */
     ...
     */
    template <class X>
    XSIMD_INLINE X operator&(const simd_batch_bool<X>& lhs, const simd_batch_bool<X>&rhs)
    {
        using value_type = typename simd_batch_traits<X>::value_type;
     ...
     */
    template <class X>
    XSIMD_INLINE X operator~(const simd_batch_bool<X>& rhs)
    {
        using value_type = typename simd_batch_traits<X>::value_type;
        using kernel = detail::batch_bool_kernel<value_type, simd_batch_traits<X>::size>;
     ...
     */
    template <class X>
    XSIMD_INLINE bool all(const simd_batch_bool<X>& rhs)
    {
        using value_type = typename simd_batch_traits<X>::value_type;
        using kernel = detail::batch_bool_kernel<value_type, simd_batch_traits<X>::size>;
     ...
     */
    template <class X>
    XSIMD_INLINE bool any(const simd_batch_bool<X>& rhs)
    {
        using value_type = typename simd_batch_traits<X>::value_type;
        using kernel = detail::batch_bool_kernel<value_type, simd_batch_traits<X>::size>;
     ...
     */
    template <class X>
    XSIMD_INLINE X operator&&(const simd_batch_bool<X>& lhs, bool rhs)
    {
        return lhs() & X(rhs);
    }
     ...
     */
    template <class X>
    XSIMD_INLINE X operator&&(bool lhs, const simd_batch_bool<X>& rhs)
    {
        return X(lhs) & rhs();
    }
     ...
     */
    template <class X>
    XSIMD_INLINE std::ostream& operator<<(std::ostream& out, const simd_batch_bool<X>& rhs)
    {
        out << '(';
