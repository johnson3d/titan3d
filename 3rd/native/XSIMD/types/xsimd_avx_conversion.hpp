...
namespace xsimd
{
    ...
    XSIMD_INLINE batch<int32_t, 8> to_int(const batch<float, 8>& x)
    {
        return _mm256_cvttps_epi32(x);
    }

    XSIMD_INLINE batch<int64_t, 4> to_int(const batch<double, 4>& x)
    {
    ...
    XSIMD_INLINE batch<float, 8> to_float(const batch<int32_t, 8>& x)
    {
        return _mm256_cvtepi32_ps(x);
    }

    XSIMD_INLINE batch<double, 4> to_float(const batch<int64_t, 4>& x)
    {
#if defined(XSIMD_AVX512VL_AVAILABLE) & defined(XSIMD_AVX512DQ_AVAILABLE)
    ...
    XSIMD_INLINE batch_bool<int32_t, 8> bool_cast(const batch_bool<float, 8>& x)
    {
        return _mm256_castps_si256(x);
    }

    XSIMD_INLINE batch_bool<int64_t, 4> bool_cast(const batch_bool<double, 4>& x)
    {
        return _mm256_castpd_si256(x);
    }

    XSIMD_INLINE batch_bool<float, 8> bool_cast(const batch_bool<int32_t, 8>& x)
    {
        return _mm256_castsi256_ps(x);
    }

    XSIMD_INLINE batch_bool<double, 4> bool_cast(const batch_bool<int64_t, 4>& x)
    {
