...
#define XSIMD_REPEAT_8_0(op, addx)    \
    CASEOP(EXPAND(op), 1 + addx);       \
    CASEOP(EXPAND(op), 2 + addx);       \
    CASEOP(EXPAND(op), 3 + addx);       \
    CASEOP(EXPAND(op), 4 + addx);       \
    CASEOP(EXPAND(op), 5 + addx);       \
    CASEOP(EXPAND(op), 6 + addx);       \
    CASEOP(EXPAND(op), 7 + addx);

#define XSIMD_REPEAT_8_N(op, addx)    \
    CASEOP(EXPAND(op), 0 + addx);       \
...
namespace xsimd
{
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 8>::batch_bool()
    {
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 8>::batch_bool(bool b)
        : m_value(vdupq_n_u16(
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 8>::batch_bool(bool b0, bool b1, bool b2, bool b3,
                                        bool b4, bool b5, bool b6, bool b7)
        : m_value{
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 8>::batch_bool(const simd_type& rhs)
        : m_value(rhs)
    {
    }
    ...
    template <class T>
    template <class V>
    XSIMD_INLINE batch_bool<T, 8>::batch_bool(const batch_bool<V, 8>& rhs)
        : m_value(static_cast<simd_type>(rhs))
    {
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 8>& batch_bool<T, 8>::operator=(const simd_type& rhs)
    {
        m_value = rhs;
        return *this;
    }
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 8>::operator uint16x8_t() const
    {
        return m_value;
    }

    template <class T>
    XSIMD_INLINE bool_proxy<uint16_t> batch_bool<T, 8>::operator[](std::size_t index)
    {
        return bool_proxy<uint16_t>(m_array[index & 7]);
    }

    template <class T>
    XSIMD_INLINE bool batch_bool<T, 8>::operator[](std::size_t index) const
    {
        return static_cast<bool>(m_array[index & 7]);
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 8>& batch_bool<T, 8>::load_values(bool b0, bool b1, bool b2, bool b3,
                                                           bool b4, bool b5, bool b6, bool b7)
    {
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 4>::batch_bool()
    {
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 4>::batch_bool(bool b)
        : m_value(vdupq_n_u32(
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 4>::batch_bool(bool b0, bool b1, bool b2, bool b3)
        : m_value{
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 4>::batch_bool(const simd_type& rhs)
        : m_value(rhs)
    {
    }
    ...
    template <class T>
    template <class V>
    XSIMD_INLINE batch_bool<T, 4>::batch_bool(const batch_bool<V, 4>& rhs)
        : m_value(static_cast<simd_type>(rhs))
    {
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 4>& batch_bool<T, 4>::operator=(const simd_type& rhs)
    {
        m_value = rhs;
        return *this;
    }
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 4>::operator uint32x4_t() const
    {
        return m_value;
    }

    template <class T>
    XSIMD_INLINE bool_proxy<uint32_t> batch_bool<T, 4>::operator[](std::size_t index)
    {
        return bool_proxy<uint32_t>(m_array[index & 3]);
    }

    template <class T>
    XSIMD_INLINE bool batch_bool<T, 4>::operator[](std::size_t index) const
    {
        return static_cast<bool>(m_array[index & 3]);
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 4>& batch_bool<T, 4>::load_values(bool b0, bool b1, bool b2, bool b3)
    {
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 16>::batch_bool()
    {
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 16>::batch_bool(bool b)
        : m_value(vdupq_n_u8(
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 16>::batch_bool(bool b1,  bool b2,  bool b3,  bool b4,
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 16>::batch_bool(const simd_type& rhs)
        : m_value(rhs)
    {
    }
    ...
    template <class T>
    template <class V>
    XSIMD_INLINE batch_bool<T, 16>::batch_bool(const batch_bool<V, 16>& rhs)
        : m_value(static_cast<simd_type>(rhs))
    {
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 16>& batch_bool<T, 16>::operator=(const simd_type& rhs)
    {
        m_value = rhs;
        return *this;
    }
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 16>::operator uint8x16_t() const
    {
        return m_value;
    }

    template <class T>
    XSIMD_INLINE bool_proxy<uint8_t> batch_bool<T, 16>::operator[](std::size_t index)
    {
        return bool_proxy<uint8_t>(m_array[index & 15]);
    }

    template <class T>
    XSIMD_INLINE bool batch_bool<T, 16>::operator[](std::size_t index) const
    {
        return static_cast<bool>(m_array[index & 15]);
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 16>& batch_bool<T, 16>::load_values(bool b1,  bool b2,  bool b3,  bool b4,
                                                             bool b5,  bool b6,  bool b7,  bool b8,
                                                             bool b9,  bool b10, bool b11, bool b12,
                                                             bool b13, bool b14, bool b15, bool b16)
    {
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 2>::batch_bool()
    {
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 2>::batch_bool(bool b)
        : m_value(vdupq_n_u64(static_cast<uint64_t>(-(int)b)))
    {
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 2>::batch_bool(bool b0, bool b1)
        : m_value{
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 2>::batch_bool(const simd_type& rhs)
        : m_value(rhs)
    {
    }
    ...
    template <class T>
    template <class V>
    XSIMD_INLINE batch_bool<T, 2>::batch_bool(const batch_bool<V, 2>& rhs)
        : m_value(static_cast<simd_type>(rhs))
    {
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 2>& batch_bool<T, 2>::operator=(const simd_type& rhs)
    {
        m_value = rhs;
        return *this;
    }
    ...
    template <class T>
    XSIMD_INLINE batch_bool<T, 2>::operator uint64x2_t() const
    {
        return m_value;
    }

    template <class T>
    XSIMD_INLINE bool_proxy<uint64_t> batch_bool<T, 2>::operator[](std::size_t index)
    {
        return bool_proxy<uint64_t>(m_array[index & 1]);
    }

    template <class T>
    XSIMD_INLINE bool batch_bool<T, 2>::operator[](std::size_t index) const
    {
        return static_cast<bool>(m_array[index & 1]);
    }

    template <class T>
    XSIMD_INLINE batch_bool<T, 2>& batch_bool<T, 2>::load_values(bool b0, bool b1)
    {
