namespace NS_utest
{
    ...
    public partial class test_game01 : EngineNS.GamePlay.UMacrossGame
    {
        ...
        public EngineNS.Macross.UMacrossBreak breaker_GetWorld_2212945802 = new EngineNS.Macross.UMacrossBreak("breaker_GetWorld_2212945802");
        ...
        public override async System.Threading.Tasks.Task<System.Boolean> BeginPlay(EngineNS.GamePlay.UGameInstance host)
        {
            using(var guard_BeginPlay = new EngineNS.Macross.UMacrossStackGuard(mFrame_BeginPlay))
            {
                ...
                EngineNS.GamePlay.UWorld tmp_r_GetWorld_2212945802 = default(EngineNS.GamePlay.UWorld);
                ...
                if ((tmp_r_LoadScene_4192249908 != null))
                {
                }
                else
                {
                    breaker_GetWorld_2212945802.TryBreak();
                    tmp_r_GetWorld_2212945802 = tmp_r_LoadScene_4192249908.GetWorld();
                    mFrame_BeginPlay.SetWatchVariable("tmp_r_GetWorld_2212945802", tmp_r_GetWorld_2212945802);
                }
