namespace NS_utest
{
    ...
    {
        public static EngineNS.Macross.TtMacrossBreak breaker_FinalViewportSlate_45717255 = new EngineNS.Macross.TtMacrossBreak("breaker_FinalViewportSlate_45717255");
        ...
        public override void BeginDestroy(EngineNS.GamePlay.TtGameInstance host)
        {
            ...
            using(var guard_BeginDestroy = new EngineNS.Macross.TtMacrossStackGuard(mStack_BeginDestroy_2650419528,mFrame_BeginDestroy_2650419528))
            {
                ...
                breaker_FinalViewportSlate_45717255.TryBreak(mStack_BeginDestroy_2650419528, this);
