    ...
    public partial class helloword : EngineNS.GamePlay.UMacrossGame
    {
        ...
        public override async System.Threading.Tasks.Task<System.Boolean> BeginPlay(EngineNS.GamePlay.UGameInstance host)
        {
            using(var guard_BeginPlay = new EngineNS.Macross.UMacrossStackGuard(mFrame_BeginPlay))
            {
                ...
                mFrame_BeginPlay.SetWatchVariable("v_mapName_InitViewportSlateWithScene_3402544262", EngineNS.RName.GetRName("tutorials/helloword/map01.scene", EngineNS.RName.ERNameType.Game));
                mFrame_BeginPlay.SetWatchVariable("v_zMin_InitViewportSlateWithScene_3402544262", 0f);
                mFrame_BeginPlay.SetWatchVariable("v_zMax_InitViewportSlateWithScene_3402544262", 1f);
                mFrame_BeginPlay.SetWatchVariable("v_bSetToWorld_InitViewportSlateWithScene_3402544262", false);
                ...
                mFrame_BeginPlay.SetWatchVariable("tmp_r_InitViewportSlateWithScene_3402544262", tmp_r_InitViewportSlateWithScene_3402544262);
