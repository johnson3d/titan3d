namespace NS_tutorials.material
{
    ...
    public partial class test_material : EngineNS.GamePlay.UMacrossGame
    {
        ...
        public EngineNS.Macross.UMacrossBreak breaker_FindFirstChild_3783671929 = new EngineNS.Macross.UMacrossBreak("breaker_FindFirstChild_3783671929");
        ...
        public override async System.Threading.Tasks.Task<System.Boolean> BeginPlay(EngineNS.GamePlay.UGameInstance host)
        {
            using(var guard_BeginPlay = new EngineNS.Macross.UMacrossStackGuard(mFrame_BeginPlay))
            {
                ...
                EngineNS.GamePlay.Scene.UNode tmp_r_FindFirstChild_3783671929 = default(EngineNS.GamePlay.Scene.UNode);
                ...
                mFrame_BeginPlay.SetWatchVariable("v_name_FindFirstChild_3783671929", "TestMtl01");
                mFrame_BeginPlay.SetWatchVariable("v_bRecursive_FindFirstChild_3783671929", true);
                breaker_FindFirstChild_3783671929.TryBreak();
                tmp_r_FindFirstChild_3783671929 = tmp_r_LoadScene_2325663523.FindFirstChild("TestMtl01",true);
                mFrame_BeginPlay.SetWatchVariable("tmp_r_FindFirstChild_3783671929", tmp_r_FindFirstChild_3783671929);
                Member_0 = ((EngineNS.GamePlay.Scene.UMeshNode)tmp_r_FindFirstChild_3783671929);
                ret_358951701 = true;
