namespace NS_tutorials.renderpolicy
{
    ...
    public partial class test_rpolicy : EngineNS.GamePlay.UMacrossGame
    {
        ...
        EngineNS.Macross.TtMacrossStackFrame mFrame_BeginPlay_2115264093 = new EngineNS.Macross.TtMacrossStackFrame(EngineNS.RName.GetRName("tutorials/renderpolicy/test_rpolicy.macross", EngineNS.RName.ERNameType.Game));
        ...
        public override async System.Threading.Tasks.Task<System.Boolean> BeginPlay(EngineNS.GamePlay.UGameInstance host)
        {
            using(var guard_BeginPlay = new EngineNS.Macross.TtMacrossStackGuard(mFrame_BeginPlay_2115264093))
            {
                ...
                mFrame_BeginPlay_2115264093.SetWatchVariable("v_mapName_InitViewportSlateWithScene_3545170604", EngineNS.RName.GetRName("tutorials/renderpolicy/test01.scene", EngineNS.RName.ERNameType.Game));
                mFrame_BeginPlay_2115264093.SetWatchVariable("v_zMin_InitViewportSlateWithScene_3545170604", 0f);
                mFrame_BeginPlay_2115264093.SetWatchVariable("v_zMax_InitViewportSlateWithScene_3545170604", 1f);
                mFrame_BeginPlay_2115264093.SetWatchVariable("v_bSetToWorld_InitViewportSlateWithScene_3545170604", true);
                ...
                mFrame_BeginPlay_2115264093.SetWatchVariable("tmp_r_InitViewportSlateWithScene_3545170604", tmp_r_InitViewportSlateWithScene_3545170604);
                ret_3675910725 = true;
                mFrame_BeginPlay_2115264093.SetWatchVariable("ret_3675910725_1522025194", ret_3675910725);
