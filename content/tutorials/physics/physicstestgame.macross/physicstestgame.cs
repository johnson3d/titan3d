namespace NS_tutorials.physics
{
    ...
    public partial class physicstestgame : EngineNS.GamePlay.TtMacrossGame
    {
        ...
        public EngineNS.Macross.TtMacrossBreak breaker_InitViewportSlateWithScene_3265070907 = new EngineNS.Macross.TtMacrossBreak("breaker_InitViewportSlateWithScene_3265070907");
        public EngineNS.Macross.TtMacrossBreak breaker_CreateCharacterFromPrefab_2342805749 = new EngineNS.Macross.TtMacrossBreak("breaker_CreateCharacterFromPrefab_2342805749");
        ...
        public override async System.Threading.Tasks.Task<System.Boolean> BeginPlay(EngineNS.GamePlay.TtGameInstance host)
        {
            ...
            using(var guard_BeginPlay = new EngineNS.Macross.TtMacrossStackGuard(mFrame_BeginPlay_1342966456))
            {
                ...
                breaker_InitViewportSlateWithScene_3265070907.TryBreak();
                ...
                breaker_CreateCharacterFromPrefab_2342805749.TryBreak();
