...
extern "C"
{
	...
	Cpp2CS3(EngineNS, v3dxBezier, AddNode);
	Cpp2CS4(EngineNS, v3dxBezier, InsertNode);
	Cpp2CS1(EngineNS, v3dxBezier, DeleteNode);
	Cpp2CS0(EngineNS, v3dxBezier, GetIs2D);
	CSharpReturnAPI2(void, EngineNS, v3dxBezier, GetValue, float, v3dxVector3*);
	Cpp2CS2(EngineNS, v3dxBezier, GetPosition);
	Cpp2CS2(EngineNS, v3dxBezier, SetPosition);
	Cpp2CS2(EngineNS, v3dxBezier, GetControlPos1);
	Cpp2CS3(EngineNS, v3dxBezier, SetControlPos1);
	Cpp2CS2(EngineNS, v3dxBezier, GetControlPos2);
	Cpp2CS3(EngineNS, v3dxBezier, SetControlPos2);
	Cpp2CS0(EngineNS, v3dxBezier, GetNodesCount);
	Cpp2CS1(EngineNS, v3dxBezier, CopyTo);
	Cpp2CS0(EngineNS, v3dxBezier, ClearNodes);
	Cpp2CS1(EngineNS, v3dxBezier, IsInRangeX);
	Cpp2CS2(EngineNS, v3dxBezier, GetRangeX);
	Cpp2CS1(EngineNS, v3dxBezier, IsInRangeY);
	Cpp2CS2(EngineNS, v3dxBezier, GetRangeY);
	Cpp2CS1(EngineNS, v3dxBezier, IsInRangeZ);
	Cpp2CS2(EngineNS, v3dxBezier, GetRangeZ);
};