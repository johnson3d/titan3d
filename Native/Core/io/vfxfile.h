...
// Operations
	...
	// formatting using "C" strftime
	 VString Format(LPCSTR pFormat) const;
	 VString FormatGmt(LPCSTR pFormat) const;
private:
	time_t m_time;
};
...
// Operations
	...
	static vBOOL  DefinitlyLoad(LPCSTR lpszFileName, EngineNS::XNDNode &xndNode);
	static vBOOL  DefinitlySave(LPCSTR lpszFileName, EngineNS::XNDNode &xndNode);
