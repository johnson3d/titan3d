...
bool INullShaderProgram::GetShaderResourceBindInfo(UINT Index, TextureBindInfo* info) const
{
	return false;
}
...
bool INullShaderProgram::GetSamplerBindInfo(UINT Index, SamplerBindInfo* info) const
{
	return false;
}
