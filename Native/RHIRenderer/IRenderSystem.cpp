...
extern "C"
{
	...
	VFX_API IRenderSystem* SDK_CreateRenderSystem(ERHIType type, const IRenderSystemDesc* pDesc)
	{
	...
	CSharpReturnAPI0(UINT32, EngineNS, IRenderSystem, GetContextNumber);
	CSharpReturnAPI2(vBOOL, EngineNS, IRenderSystem, GetContextDesc, UINT32, IRenderContextDesc*);
}