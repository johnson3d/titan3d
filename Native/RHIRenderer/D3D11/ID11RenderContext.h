...
public:
	...
	virtual IShaderDesc* CompileHLSL(std::string hlsl, LPCSTR entry, LPCSTR sm, const IShaderDefinitions* defines) override;
	//virtual IShaderDesc* CompileHLSLFromFile(LPCSTR file, LPCSTR entry, LPCSTR sm, const IShaderDefinitions* defines) override;
