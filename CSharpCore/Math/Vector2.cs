...
namespace EngineNS
{
    ...
    public struct Vector2 : System.IEquatable<Vector2>
    {
        ...
        [Editor.MacrossMember(Editor.MacrossMemberAttribute.enMacrossType.Callable | Editor.MacrossMemberAttribute.enMacrossType.NotShowInBreak | Editor.MacrossMemberAttribute.enMacrossType.ReadOnly)]
        public static Vector2 UnitX { get { return mUnitX; } }
        static Vector2 mUnitX = new Vector2(1, 0);
        [Editor.MacrossMember(Editor.MacrossMemberAttribute.enMacrossType.Callable | Editor.MacrossMemberAttribute.enMacrossType.NotShowInBreak | Editor.MacrossMemberAttribute.enMacrossType.ReadOnly)]
        public static Vector2 UnitY { get{ return mUnitY; } }
        static Vector2 mUnitY = new Vector2(0, 1);
        [Editor.MacrossMember(Editor.MacrossMemberAttribute.enMacrossType.Callable | Editor.MacrossMemberAttribute.enMacrossType.NotShowInBreak | Editor.MacrossMemberAttribute.enMacrossType.ReadOnly)]
        public static Vector2 UnitXY { get { return mUnitXY; } }
        static Vector2 mUnitXY = new Vector2(1, 1);
        [Editor.MacrossMember(Editor.MacrossMemberAttribute.enMacrossType.Callable | Editor.MacrossMemberAttribute.enMacrossType.NotShowInBreak | Editor.MacrossMemberAttribute.enMacrossType.ReadOnly)]
        public static Vector2 InvUnitXY { get { return InvmUnitXY; } }
        static Vector2 InvmUnitXY = new Vector2(-1, -1);
        [Editor.MacrossMember(Editor.MacrossMemberAttribute.enMacrossType.Callable | Editor.MacrossMemberAttribute.enMacrossType.NotShowInBreak | Editor.MacrossMemberAttribute.enMacrossType.ReadOnly)]
        ...
        public static EngineNS.Vector2 TryParse(string str)
        {
