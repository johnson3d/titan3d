...
namespace EngineNS.Graphics.Pipeline
{
    ...
    public partial class TtGfxDevice : TtModule<TtEngine>
    {
        ...
        public readonly NxRHI.TtRCmdQueue RenderQueue = new NxRHI.TtRCmdQueue();
        ...
        {
            RenderQueue.TickLogic(host.ElapsedSecond);
        }
        public override void TickRender(TtEngine host)
        {
            RenderQueue.TickRender(host.ElapsedSecond);
        }
        [ThreadStatic]
        ...
        {
            if (TtEngine.Instance.GfxDevice.RenderContext == null)
                return;
            ...
            RenderQueue.TickSync(host.ElapsedSecond);
        ...
        protected async System.Threading.Tasks.Task<bool> InitGPU(TtEngine engine, int Adapter, NxRHI.ERhiType rhi, IntPtr window, bool bDebugLayer, bool useRenderDoc)
        {
            ...
            unsafe
            {
                ...
                RenderContext.SetDX12BreakOnId(EDx12MessageId.PIX_EVENT_UNDERFLOW, true); 
            }
