...
//{
//    public class TtDeferredPolicy : TtRenderPolicy
//    {
//        public TtDeferredPolicy()
//        {
...
//        }
//        public override Shader.UGraphicsShadingEnv GetPassShading(EShadingType type, Mesh.TtMesh mesh, int atom, Pipeline.TtRenderGraphNode node)
//        {
//            switch (type)
//            {
...
//            await BasePassNode.Initialize(this, Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<UDeferredOpaque>(), EPixelFormat.PXF_R8G8B8A8_UNORM, EPixelFormat.PXF_D24_UNORM_S8_UINT, x, y);
...
//            await DirLightingNode.Initialize(this, Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<UDeferredDirLightingShading>(), EPixelFormat.PXF_R10G10B10A2_UNORM, EPixelFormat.PXF_UNKNOWN, x, y, "DirLighting");
...
//            await HdrNode.Initialize(this, Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<Common.UHdrShading>(), EPixelFormat.PXF_R8G8B8A8_UNORM, EPixelFormat.PXF_UNKNOWN, x, y, "Hdr");
...
//            base.Dispose();
//        }
//        public override void BeginTick(GamePlay.UWorld world)
//        {
//            ParticleNode?.BeginTick(world, this, true);
//        }
//        public override void EndTick(GamePlay.UWorld world)
//        {
//            ParticleNode?.EndTick(world, this, true);
//        }
//    }
//}
