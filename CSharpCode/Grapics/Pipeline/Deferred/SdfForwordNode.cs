...
namespace EngineNS.Graphics.Pipeline.Deferred
{
    ...
    public class TtSdfForwordNode : Common.TtBasePassNode
    {
        ...
        public override async Thread.Async.TtTask Initialize(TtRenderPolicy policy, string debugName)
        {
            ...
            mOpaqueShading = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<TtSdfOpaqueShading>();
            mTranslucentShading = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<TtSdfTranslucentShading>();
