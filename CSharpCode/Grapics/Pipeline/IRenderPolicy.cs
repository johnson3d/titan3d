...
{   
    public class IRenderPolicy
    {
        ...
        public Common.URenderGraphNode QueryNode(string name)
        {
            if (name == "BasePassNode")
            {
        ...
        public virtual Common.URenderGraphNode GetRootNode()
        {
            return null;
        }
    ...
    {
        public Dictionary<FHashText, UAttachment> CachedAttachments;
    }
}
