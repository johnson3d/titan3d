...
namespace EngineNS.Graphics.Pipeline.Common
{
    ...
    public class TtHitproxyNode : TAuxRenderGraphNode<TtHitproxyNode>
    {
        ...
        public override async Thread.Async.TtTask Initialize(TtRenderPolicy policy, string debugName)
        {
            ...
            mHitproxyShading = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<TtHitproxyShading>();
        ...
        public override unsafe void Tick(GamePlay.TtWorld world, TtRenderPolicy policy, NxRHI.TtCommandList frameCmdList, bool bClear)
        {
            ...
            TtEngine.Instance.GfxDevice.RenderQueue.QueueCmd((NxRHI.FRenderCmd)((TtRCmdQueue queue, ref NxRHI.FRCmdInfo info) =>
            {
