...
namespace EngineNS.Graphics.Pipeline.Common
{
    public class UScreenTilingNode : Graphics.Pipeline.Common.URenderGraphNode
    {
        ...
        private unsafe void ResetComputeDrawcall(IRenderPolicy policy)
        {
            ...
            var gpuScene = policy.QueryNode("GpuSceneNode") as Common.UGpuSceneNode;
            ...
            if (srvIdx != (IShaderBinder*)0)
            {
                ...
                SetupTileDataDrawcall.mCoreObject.GetShaderRViewResources().BindCS(srvIdx->CSBindPoint, depth.mCoreObject);
            }
        ...
        public override unsafe void TickLogic(GamePlay.UWorld world, Graphics.Pipeline.IRenderPolicy policy, bool bClear)
        {
            ...
            if (ConfigCBuffer != null)
            {
                ...
                ConfigCBuffer.mCoreObject.UpdateDrawPass(cmd, 1);
            }
            ...
            #region Setup
            {
                if (gpuScene != null)
                {
                    ...
                    if (srvIdx != (IShaderBinder*)0)
                    {
                        PushLightToTileDataDrawcall.mCoreObject.GetShaderRViewResources().BindCS(srvIdx->CSBindPoint, gpuScene.PointLights.DataSRV.mCoreObject);
                    }
                }
                SetupTileDataDrawcall.mCoreObject.BuildPass(cmd);
            ...
            #region PushLights
            {
                PushLightToTileDataDrawcall.mCoreObject.BuildPass(cmd);
