...
namespace EngineNS.Graphics.Pipeline.Common
{
    ...
    public class UScreenTilingNode : Graphics.Pipeline.TtRenderGraphNode
    {
        ...
        public class SetupTileDataShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
        ...
        public class PushLightToTileDataShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
            public override Vector3ui DispatchArg
            {
                get => new Vector3ui(32, 32, 1);
