...
namespace EngineNS.Graphics.Pipeline.Common
{
    public partial class UGpuSceneNode
    {
        ...
        public class CullGpuIndexsShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
        ...
        public class SetupCullClusterArgsShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
            public override Vector3ui DispatchArg
            {
                //get => new Vector3ui((MathHelper.Max(1, MathHelper.DivideAndRoundUp((uint)GpuSceneActors.Count, 64u))), 1, 1);
        ...
        public class CullClusterShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
            public override Vector3ui DispatchArg
            {
                //get => new Vector3ui((MathHelper.Max(1, MathHelper.DivideAndRoundUp((uint)GpuSceneActors.Count, 64u))), 1, 1);
        ...
        public class SetupDrawClusterArgsBufferShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
            public override Vector3ui DispatchArg
            {
                //get => new Vector3ui((MathHelper.Max(1, MathHelper.DivideAndRoundUp((uint)GpuSceneActors.Count, 64u))), 1, 1);
