...
namespace EngineNS.Graphics.Pipeline.Common
{
    ...
    public class UAvgBrightnessNode : Graphics.Pipeline.TtRenderGraphNode
    {
        ...
        public class SetupAvgBrightnessShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
        ...
        public class CountAvgBrightnessShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
            public override Vector3ui DispatchArg
            {
                get => new Vector3ui(32, 32, 1);
