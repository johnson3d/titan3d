...
namespace EngineNS.Graphics.Pipeline.Common
{
    ...
    public class TtHzbNode : TAuxRenderGraphNode<TtHzbNode>
    {
        ...
        public async override Thread.Async.TtTask Initialize(TtRenderPolicy policy, string debugName)
        {
            ...
            Setup = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<SetupShading>();

            DownSample = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<DownSampleShading>();
