...
namespace EngineNS.Graphics.Pipeline.Common
{
    ...
    public class TtScreenTilingNode : TAuxRenderGraphNode<TtScreenTilingNode>
    {
        ...
        public async override Thread.Async.TtTask Initialize(TtRenderPolicy policy, string debugName)
        {
            ...
            SetupTileData = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<SetupTileDataShading>();
            PushLightToTileData = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<PushLightToTileDataShading>();
        }
