...
namespace EngineNS.Graphics.Pipeline.Common
{
    ...
    public class TtAvgBrightnessNode : TAuxRenderGraphNode<TtAvgBrightnessNode>
    {
        ...
        public override async Thread.Async.TtTask Initialize(TtRenderPolicy policy, string debugName)
        {
            ...
            CountAvgBrightness = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<CountAvgBrightnessShading>();
            SetupAvgBrightness = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<SetupAvgBrightnessShading>();
