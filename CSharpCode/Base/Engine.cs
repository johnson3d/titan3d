...
namespace EngineNS
{
    ...
    public partial class TtEngine : TtModuleHost<TtEngine>
    {
        ...
        public async System.Threading.Tasks.Task<bool> PreInitEngine(string cfgFile, bool bNatvieMemory)
        {
            ...
            if (this.DataCopyer == null)
            {
                Profiler.Log.WriteLine<Profiler.TtCoreGategory>(Profiler.ELogTag.Error, $"DataCopyer is null,Please sure DataCopyer Plugin was used");
                return false;
            }
