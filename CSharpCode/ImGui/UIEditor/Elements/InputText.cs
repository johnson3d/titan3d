    ...
    public class InputText : ControlBase
    {
        ...
        public unsafe override void GenCode(Form form)
        {
            ...
            if (Binder != null)
            {
                ...
                form.AddLine($"var buffer = {typeof(BigStackBuffer).FullName}.CreateInstance({MaxInputChars});");
            ...
            {
                form.AddLine($"var buffer = new {typeof(BigStackBuffer).FullName}.CreateInstance({MaxInputChars}, true);");
