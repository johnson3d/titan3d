...
namespace EngineNS.Editor.Forms
{
    ...
    {
        public TtPermutationItem IsTex3D
        {
            get;
            set;
        }
    ...
    public class TtTextureViewer : Editor.IAssetEditor, IRootForm
    {
        ...
        public async Thread.Async.TtTask<bool> OpenEditor(TtMainEditorApplication mainEditor, RName name, object arg, bool saveLayout)
        {
            ...
            if (TextureSRV.CubeFaces == 6)
            {
                ...
                ShadingEnv = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<TtSlateTextureCubeViewerShading>();
            }
            else
            {
                ShadingEnv = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<TtSlateTextureViewerShading>();
            }
