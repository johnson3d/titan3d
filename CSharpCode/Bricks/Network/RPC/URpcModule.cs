...
namespace EngineNS.Bricks.Network.RPC
{
	...
	public abstract class TtReturnAwaiterBase : IPooledObject, IDisposable
	{
        ...
        public delegate void FReturnCallBack(ref IO.AuxReader<IO.TtMemReader> pkg, bool isTimeOut, TtReturnAwaiterBase awaiter);
        public FReturnContext Context;
        ...
        public abstract void RemoteReturnCall(ref IO.AuxReader<IO.TtMemReader> pkg, bool isTimeOut);
    ...
    {
        #region life manage
        public class UReturnAwaiterAllocator : TtObjectPool<TtReturnAwaiter<T>>
        {
            protected override bool OnObjectRelease(TtReturnAwaiter<T> obj)
            {
                obj.Reset();
				obj.ReturnContext = null;
                return true;
            }
            public override string ShowName
			{
				get
				{
					return $"TtReturnAwaiter<{typeof(T).FullName}>";
				}
			}
		}
        static UReturnAwaiterAllocator mAllocator = new UReturnAwaiterAllocator();
        
		public static TtReturnAwaiter<T> CreateInstance(uint timeOut, TtReturnContext retContext)
		{
        ...
        public override void RemoteReturnCall(ref IO.AuxReader<IO.TtMemReader> pkg, bool isTimeOut)
		{
        ...
        {
            Result = default(T);//todo: pooled ISerilaizer
    ...
    public partial class TtRpcManager : IRpcHost
    {
        ...
        public virtual INetConnect GetRunTargetConnect(in FReturnContext retCtx, INetConnect connect)
		{
            return null;
        }
	...
	public class TtRpcModule : TtModule<TtEngine>
	{
		...
		public void RemoteReturn(UInt32 handle, ref IO.AuxReader<IO.TtMemReader> pkg)
		{
...
namespace EngineNS
{
    ...
    {
        public Bricks.Network.RPC.TtRpcModule RpcModule { get; } = new Bricks.Network.RPC.TtRpcModule();
    }
}
...
namespace EngineNS.UnitTest
{
	...
	{
		public static async Thread.Async.TtTask<int> TestRpc1(float arg, EngineNS.Bricks.Network.RPC.FRpcCallArg rpcArg)
		{
			var ExeIndex = rpcArg.ExeIndex;
			var NetConnect = rpcArg.NetConnect;
			if (ExeIndex == UInt16.MaxValue)
		...
		public static async Thread.Async.TtTask<IO.ISerializer> TestRpc3(int arg, EngineNS.Bricks.Network.RPC.FRpcCallArg rpcArg)
		{
			var ExeIndex = rpcArg.ExeIndex;
			var NetConnect = rpcArg.NetConnect;
			if (ExeIndex == UInt16.MaxValue)
		...
		public static async Thread.Async.TtTask<string> TestRpc4(string arg, EngineNS.Bricks.Network.RPC.FRpcCallArg rpcArg)
		{
			var ExeIndex = rpcArg.ExeIndex;
			var NetConnect = rpcArg.NetConnect;
			if (ExeIndex == UInt16.MaxValue)
		...
		public static async Thread.Async.TtTask<Vector3> TestRpc5(Vector3 arg, EngineNS.Bricks.Network.RPC.FRpcCallArg rpcArg)
		{
			var ExeIndex = rpcArg.ExeIndex;
			var NetConnect = rpcArg.NetConnect;
			if (ExeIndex == UInt16.MaxValue)
...
namespace EngineNS.UnitTest
{
	...
	{
		public static EngineNS.Bricks.Network.RPC.FCallMethod rpc_TestRpc1 = (EngineNS.IO.AuxReader<EngineNS.IO.TtMemReader> reader, object host, EngineNS.Bricks.Network.RPC.TtCallContext context) =>
		{
			float arg;
			reader.Read(out arg);
			FReturnContext retContext;
