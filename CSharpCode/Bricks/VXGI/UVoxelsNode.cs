...
namespace EngineNS.Bricks.VXGI
{
    public partial class UVoxelsNode : Graphics.Pipeline.TtRenderGraphNode
    {
        ...
        public class SetupVoxelGroupAllocatorShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
        ...
        public class InjectVoxelsShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
            public override Vector3ui DispatchArg
            {
        ...
        public class EraseVoxelGroupShading : Graphics.Pipeline.Shader.UComputeShadingEnv
        {
            public override Vector3ui DispatchArg
            {
