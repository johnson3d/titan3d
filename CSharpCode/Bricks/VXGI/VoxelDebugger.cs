...
namespace EngineNS.Bricks.VXGI
{
    ...
    [Bricks.CodeBuilder.ContextMenu("Voxelize", "GI\\Voxelize", Bricks.RenderPolicyEditor.TtPolicyGraph.RGDEditorKeyword)]
    partial class UVoxelsNode
    {
        ...
        private async Thread.Async.TtTask<bool> InitVxDebugger(Graphics.Pipeline.Shader.TtMaterial material)
        {
            ...
            CoreSDK.DisposeObject(ref SetupVxDebuggerDrawcall);
            SetupVxDebuggerDrawcall = rc.CreateComputeDraw();
            SetupVxDebugger = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<SetupVxDebuggerShading>();
            
            CollectVxDebugger = await Graphics.Pipeline.Shader.TtShadingEnv.CreateShadingEnv<CollectVxDebuggerShading>();
