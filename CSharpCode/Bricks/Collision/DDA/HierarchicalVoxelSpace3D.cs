...
namespace EngineNS.Bricks.Collision.DDA
{
    ...
    public class TtHierarchicalVoxelSpace3D : GamePlay.Scene.TtSceneActorNode
    {
        ...
        public Graphics.Mesh.TtMdfInstanceStaticMesh DebugMeshInstanceMdf
        {
            get
            {
                if (VxDebugMesh == null)
                    return null;
                return VxDebugMesh.MdfQueue as Graphics.Mesh.TtMdfInstanceStaticMesh;
            }
        }
        ...
        public async System.Threading.Tasks.Task CreateDebugMesh(GamePlay.TtWorld world)
        {
            ...
            VxDebugMesh.Initialize(rectMesh, materials, Rtti.TtTypeDescGetter<Graphics.Mesh.TtMdfInstanceStaticMesh>.TypeDesc);
