...
namespace EngineNS.Bricks.Collision.Octree
{
    public class TtBoundsOctreeNode<T>
    {
        ...
        public void DrawAllBounds(GamePlay.TtWorld.UVisParameter vp, GamePlay.UPlacementBase placement, float depth)
        {
        ...
        /// </summary>
        public void DrawAllObjects(GamePlay.TtWorld.UVisParameter vp, GamePlay.UPlacementBase placement)
        {
