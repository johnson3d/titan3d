...
namespace EngineNS.Bricks.StateMachine.Macross.SubState{
    ...
    public class TtGraphElement_TimedSubState : TtDescriptionGraphElement, IStateTransitionAcceptable, IStateTransitionInitial, IEnumChild
    {
        ...
        protected TtTimedCompoundStateClassDescription ParentTimedCompoundStateClassDescription { get => Description.Parent as TtTimedCompoundStateClassDescription; }
        ...
        public TtGraphElement_TimedSubState(IDescription description, IGraphElementStyle style) : base(description, style)
        {
            ...
            DurationTextBlock.VerticalAlignment = EVerticalAlignment.Center;
