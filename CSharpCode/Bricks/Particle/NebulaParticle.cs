...
namespace EngineNS.Bricks.Particle
{
    ...
    public partial class TtNebulaParticle : IO.BaseSerializer, IO.IAsset, IDisposable
    {
        ...
        public void Update(Graphics.Pipeline.TtRenderPolicy policy, TtParticleGraphNode particleSystem, float elpased, Vector3 Location)
        {
    ...
    public partial class TtNebulaMacross : Macross.AuxMacrossObject
    {
        ...
        [Rtti.Meta("")]
        public virtual void OnUpdate(TtNebulaParticle nebula, TtParticleGraphNode particleSystem, float elpased)
        {

        }
        [Rtti.Meta("")]
        public virtual void OnUpdateEmitter(TtNebulaParticle nebula, TtEmitter emitter, TtParticleGraphNode particleSystem, float elpased)
        {
...
namespace EngineNS.Bricks.Particle
{
	partial class TtNebulaMacross
	{
		...
		public unsafe void macross_OnUpdate (EngineNS.Macross.TtMacrossStackTracer mcStack, string nodeName, TtNebulaParticle nebula, TtParticleGraphNode particleSystem, float elpased) 
		{
			var stackframe = mcStack.TopFrame;
			{
				if(stackframe != null)
		...
		public unsafe void macross_OnUpdateEmitter (EngineNS.Macross.TtMacrossStackTracer mcStack, string nodeName, TtNebulaParticle nebula, TtEmitter emitter, TtParticleGraphNode particleSystem, float elpased) 
		{
			var stackframe = mcStack.TopFrame;
			{
				if(stackframe != null)
