...
namespace EngineNS.Bricks.GpuDriven
{
    ...
    public struct FRasterTriangle_Rect
    {
        ...
        public void Rasterize(StbImageSharp.TtMemImage image, Color4b clr, ref Vector2i a, ref Vector2i B, ref Vector2i C)
        {
    ...
    {
        public void Rasterize(StbImageSharp.TtMemImage image, Color4b clr, ref Vector2i v1, ref Vector2i v2, ref Vector2i v3)
        {
            var Size = new Vector2i(image.Width, image.Height);
        ...
        private void DrawTopFlatTriangle(StbImageSharp.TtMemImage image, Color4b clr, in Vector2i Size, in Vector2i v1, in Vector2i v2, in Vector2i v3)
        {
        ...
        private void DrawBottomFlatTriangle(StbImageSharp.TtMemImage image, Color4b clr, in Vector2i Size, in Vector2i v1, in Vector2i v2, in Vector2i v3)
        {
    ...
    public class TtSwRasterizeDispatchArgShading : Graphics.Pipeline.Shader.TtComputeShadingEnv
    {
    ...
    public class TtSwRasterizeSetUpShading : Graphics.Pipeline.Shader.TtComputeShadingEnv
    {
        public override Vector3ui DispatchArg
        {
    ...
    public class TtSwRasterizeShading : Graphics.Pipeline.Shader.TtComputeShadingEnv
    {
        public override Vector3ui DispatchArg
        {
    ...
    public class TtQuarkResolveShading : Graphics.Pipeline.Shader.TtGraphicsShadingEnv
    {
...
namespace EngineNS.UnitTest
{
    ...
    public class UTest_TtSoftRaster
    {
        ...
        public void UnitTestEntrance()
        {
            ...
            {
                var image = StbImageSharp.TtMemImage.CreateImage(1024, 1024, StbImageSharp.ColorComponents.RedGreenBlueAlpha);
