...
namespace EngineNS.DesignMacross.Editor.DeclarationPanel
{
    ...
    public class TtVariableOutlinerElement : IOutlineElement
    {
    ...
    public class TtVariableOutlinerElementRender : IOutlineElementRender
    {
        public void Draw(IRenderableElement renderableElement, ref FOutlineElementRenderingContext context)
        {
            var variable = renderableElement as TtVariableOutlinerElement;
            ...
            TtVariableOutlinerElement removeVar = null;
