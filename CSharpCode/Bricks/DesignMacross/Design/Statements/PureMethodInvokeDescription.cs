...
namespace EngineNS.DesignMacross.Design.Statement
{
    ...
    public class TtPureMethodInvokeDescription : TtPureStatementDescription
    {
        public static TtPureMethodInvokeDescription Create(TtClassMeta.TtMethodMeta methodMeta)
        {
            var methodInvoke = new TtPureMethodInvokeDescription();
        ...
        public static TtPureMethodInvokeDescription Create(MethodInfo methodInfo)
        {
            var methodInvoke = new TtPureMethodInvokeDescription();
        ...
        public TtPureMethodInvokeDescription()
        {
        ...
        public override TtStatementBase BuildStatement(ref FStatementBuildContext statementBuildContext)
        {
            ...
            foreach (var pin in otherInPins)
            {
                ...
                else
                {
                    ...
                    if (linkedDesc is TtStatementDescription linkedStatementDesc)
                    {
                        var linkedStatement = linkedStatementDesc.BuildStatement(ref statementBuildContext);
                        statementBuildContext.AddStatement(linkedStatement);
