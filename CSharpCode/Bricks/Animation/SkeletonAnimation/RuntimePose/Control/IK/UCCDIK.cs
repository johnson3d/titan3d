...
{
    public class UCCDIK : URuntimePoseControl
    {
        Pose.ULocalSpaceRuntimePose mInPose = null;
        public Pose.ULocalSpaceRuntimePose InPose
        {
            get => mInPose;
            set
            {
                mInPose = value;
                mLocalSpacePose = URuntimePoseUtility.CopyPose(InPose);
                mMeshSpacePose = URuntimePoseUtility.ConvetToMeshSpaceRuntimePose(mLocalSpacePose);
            }
        }
        Pose.ULocalSpaceRuntimePose mLocalSpacePose = null;
        Pose.UMeshSpaceRuntimePose mMeshSpacePose = null;
        ...
        public string RootBoneName
        {
            ...
            set
            {
                ...
                if (mMeshSpacePose == null)
                    return;
                BuildBoneChain(URuntimePoseUtility.GetDesc(mEndEffecterBoneName, mMeshSpacePose), URuntimePoseUtility.GetDesc(value, mMeshSpacePose));
            }
        }
