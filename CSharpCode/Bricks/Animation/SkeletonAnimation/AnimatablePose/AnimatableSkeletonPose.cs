...
{
    public partial class TtAnimatableSkeletonPose : IAnimatableLimbPose
    {
        public TtAnimatableSkeletonPose()
        {
        }
        public TtAnimatableSkeletonPose(Skeleton.TtSkinSkeletonDesc desc)
        {
            mDesc = desc;
        }
        private Skeleton.TtSkinSkeletonDesc mDesc;
        ...
        public void ConstructHierarchy()
        {
            ...
            for (int i = 0; i < LimbPoses.Count; ++i)
            {
                ...
                var bone = limbPose.Desc as TtBoneDesc;
        ...
        {
            var pose = new TtAnimatableSkeletonPose(mDesc);
            for (int i = 0; i < LimbPoses.Count; ++i)
            {
