        ...
        void StartTransAxis(Graphics.Pipeline.UViewportSlate viewport, in SDL2.SDL.SDL_Event e)
        {
            ...
            switch(mCurrentAxisType)
            {
                ...
                case enAxisType.Scale_X:
                    {
                        Vector3 transAxis;
                        Vector3.TransformNormal(ref Vector3.UnitX, ref startWorldMat, out transAxis);
                ...
                case enAxisType.Scale_Plane_XY:
                    {
                        EngineNS.Vector3.TransformNormal(ref EngineNS.Vector3.UnitZ, ref startWorldMat, out planeAxis);
                    }
                    break;
                case enAxisType.Move_Y:
                case enAxisType.Scale_Y:
                    {
                        ...
                        EngineNS.Vector3.TransformNormal(ref EngineNS.Vector3.UnitY, ref startWorldMat, out transAxis);
                ...
                case enAxisType.Scale_Plane_XZ:
                    {
                        EngineNS.Vector3.TransformNormal(ref EngineNS.Vector3.UnitY, ref startWorldMat, out planeAxis);
                    }
                    break;
                case enAxisType.Move_Z:
                case enAxisType.Scale_Z:
                    {
                        EngineNS.Vector3 transAxis;
                        EngineNS.Vector3.TransformNormal(ref EngineNS.Vector3.UnitZ, ref startWorldMat, out transAxis);
                        var tempNormal = EngineNS.Vector3.Cross(transAxis, cameraDirection);
                        tempNormal.Normalize();
                        planeAxis = EngineNS.Vector3.Cross(transAxis, tempNormal);
                        planeAxis.Normalize();
                ...
                case enAxisType.Scale_Plane_YZ:
                    {
                        EngineNS.Vector3.TransformNormal(ref EngineNS.Vector3.UnitX, ref startWorldMat, out planeAxis);
                    }
                    break;
                ...
                case enAxisType.Edge_X_MaxPlane:
                    {
                        EngineNS.Vector3 transAxis;
                        EngineNS.Vector3.TransformNormal(ref EngineNS.Vector3.UnitX, ref startWorldMat, out transAxis);
                        var tempNormal = EngineNS.Vector3.Cross(transAxis, cameraDirection);
                        tempNormal.Normalize();
                        planeAxis = EngineNS.Vector3.Cross(transAxis, tempNormal);
                        planeAxis.Normalize();
        ...
        async System.Threading.Tasks.Task TransAxis(Vector2 newMouseLoc)
        {
            ...
            switch(mCurrentAxisType)
            {
                case enAxisType.Move_X:
                    {
                        Vector3 transAxis;
                        Vector3.TransformNormal(ref Vector3.UnitX, ref startTransMat, out transAxis);
                ...
                case enAxisType.Move_Y:
                    {
                        Vector3 transAxis;
                        Vector3.TransformNormal(ref Vector3.UnitY, ref startTransMat, out transAxis);
                        MoveWithAxis(in newMouseLoc, transAxis);
                    }
                    break;
                case enAxisType.Move_Z:
                    {
                        Vector3 transAxis;
                        Vector3.TransformNormal(ref Vector3.UnitZ, ref startTransMat, out transAxis);
                        MoveWithAxis(in newMouseLoc, transAxis);
                    }
                    break;
            }
