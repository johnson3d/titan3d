...
namespace EngineNS
{
    ...
    public struct Vector4ui : System.IEquatable<Vector4ui>
    {
        ...
        public class Vector4EditorAttribute : EGui.Controls.PropertyGrid.TtPGCustomValueEditorAttribute
        {
            public override unsafe bool OnDraw(in EditorInfo info, out object newValue)
            {
                ...
                else
                {
                    ...
                    var changed = ImGuiAPI.DragScalarN2("##" + info.Name, ImGuiDataType_.ImGuiDataType_Float, (uint*)&v, 4, speed, &minValue, &maxValue, format, ImGuiSliderFlags_.ImGuiSliderFlags_None);
