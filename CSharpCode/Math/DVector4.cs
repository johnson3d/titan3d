...
namespace EngineNS
{
    ...
    public struct DVector4 : System.IEquatable<DVector4>
    {
        ...
        public class DVector4EditorAttribute : EGui.Controls.PropertyGrid.TtPGCustomValueEditorAttribute
        {
            public override unsafe bool OnDraw(in EditorInfo info, out object newValue)
            {
                ...
                else
                {
                    ...
                    var changed = ImGuiAPI.DragScalarN2("##" + info.Name, ImGuiDataType_.ImGuiDataType_Double, (double*)&v, 4, speed, &minValue, &maxValue, format, ImGuiSliderFlags_.ImGuiSliderFlags_None);
