...
namespace EngineNS
{
    ...
    public struct DVector3 : System.IEquatable<DVector3>
    {
        ...
        public class DVector3EditorAttribute : EGui.Controls.PropertyGrid.TtPGCustomValueEditorAttribute
        {
            public override unsafe bool OnDraw(in EditorInfo info, out object newValue)
            {
                ...
                else
                {
                    ...
                    var changed = ImGuiAPI.DragScalarN2("##" + info.Name, ImGuiDataType_.ImGuiDataType_Double, (double*)&v, 3, speed, &minValue, &maxValue, format, ImGuiSliderFlags_.ImGuiSliderFlags_None);
